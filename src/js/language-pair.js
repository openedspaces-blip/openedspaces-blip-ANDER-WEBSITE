...
(function (root, factory) {
  ...
  const INTERFACE_LABELS = {
    spanish: {
      ...
      targetCourseLabel: 'Idioma que aprenderás (L2)',
      targetLevelLabel: 'Nivel de',
      supportInterfaceLabel: 'Idioma de apoyo e interfaz (L1)',
      supportLevelHint: 'No modifica el nivel del curso.',
    ...
    english: {
      ...
      targetCourseLabel: 'Language you are learning (L2)',
      targetLevelLabel: 'Level of',
      supportInterfaceLabel: 'Support and interface language (L1)',
      supportLevelHint: 'This does not change your course level.',
    ...
    french: {
      ...
      targetCourseLabel: 'Langue que vous apprenez (L2)',
      targetLevelLabel: 'Niveau de',
      supportInterfaceLabel: "Langue d'appui et d'interface (L1)",
      supportLevelHint: 'Cela ne change pas le niveau du cours.',
