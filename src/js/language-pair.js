...
(function (root, factory) {
  ...
  const UI_STRINGS = {
    spanish: {
      ...
      aboutCreatorJourney1: 'Docencia de lenguas extranjeras en nivel secundario',
      aboutCreatorJourney2: 'Estudios de Maestría en la UASD',
      aboutCreatorVision: 'Una plataforma nacida del aula para que el estudio constante se convierta en progreso real.',
    ...
    english: {
      ...
      aboutCreatorJourney1: 'Secondary-level foreign-language teaching',
      aboutCreatorJourney2: 'Master’s studies at UASD',
      aboutCreatorVision: 'A platform born in the classroom, helping consistent study become real progress.',
    ...
    french: {
      ...
      aboutCreatorJourney1: 'Enseignement des langues étrangères au secondaire',
      aboutCreatorJourney2: 'Études de master à l’UASD',
      aboutCreatorVision: 'Une plateforme née de la classe pour transformer la régularité en progrès réel.',
