...
(function () {
  ...
  // Meanings follow the exact order of `lists`. A frequency label is useful
  // metadata, but must never replace the learner's Spanish translation.
  const spanishMeanings = {
    italian: 'ser tener hacer decir ir ver saber poder querer venir deber tomar encontrar dar hablar poner pasar mirar amar creer preguntar quedarse responder sentir pensar llegar conocer convertirse mantener entender esperar salir vivir entrar llevar buscar volver llamar morir partir seguir escribir mostrar caer abrir parar perder comenzar caminar escuchar subir recibir servir terminar reír leer dejar continuar comer beber correr dormir trabajar jugar estudiar aprender elegir lograr reflexionar llenar crecer actuar intentar usar cambiar ayudar ganar olvidar cerrar explicar comprar vender enviar conducir construir nacer lanzar decidir iniciar recordar pagar encontrar viajar lavar cocinar telefonear preferir ofrecer gastar mandar'.split(' '),
    portuguese: 'ser estar tener hacer decir ir ver saber poder querer venir deber tomar encontrar dar hablar poner pasar mirar amar creer preguntar quedarse responder oír pensar llegar conocer convertirse sentir mantener entender esperar salir vivir entrar llevar buscar volver llamar morir partir seguir escribir mostrar caer abrir parar perder comenzar caminar subir recibir servir terminar reír leer dejar continuar comer beber correr dormir trabajar jugar estudiar aprender elegir conseguir reflexionar llenar crecer actuar intentar usar cambiar ayudar ganar olvidar cerrar explicar comprar vender enviar conducir construir nacer lanzar decidir recordar pagar viajar lavar cocinar telefonear preferir ofrecer gastar mandar visitar vivir necesitar'.split(' '),
    german: 'ser tener convertirse hacer decir ir ver saber poder querer venir deber tomar encontrar dar hablar poner quedarse amar creer preguntar responder oír pensar llegar conocer sentir mantener entender esperar salir vivir entrar llevar buscar volver llamar morir dejar seguir escribir mostrar caer abrir parar perder comenzar correr escuchar subir recibir servir terminar reír leer dejar continuar comer beber correr dormir trabajar jugar estudiar aprender elegir lograr reflexionar llenar crecer actuar intentar usar cambiar ayudar ganar olvidar cerrar explicar comprar vender enviar conducir construir lanzar decidir comenzar pagar encontrar viajar lavar cocinar llamar preferir ofrecer gastar enviar visitar vivir necesitar'.split(' ')
  };
  const meta = {
  ...
  Object.entries(lists).forEach(([language, words]) => {
    window.ANDERGO_VERBS_DATA[language] = words.slice(0, 100).map((infinitive, index) => {
      ...
      return { id: `verb-${language}-${infinitive}`, language, rank: index + 1, infinitive, regular: true, group: 'formas esenciales', level, forms: { thirdPersonSingular: forms.present[2], pastSimple: forms.past[0], pastParticiple: forms.pp, presentParticiple: '—', presentRows: forms.present, pastRows: forms.past }, translation: { spanish: spanishMeanings[language][index] }, directDefinition: { [language]: `Verbo frecuente: ${infinitive}.` }, pronunciation: '', audioText: infinitive, examples: {}, commonCollocations: [], synonyms: [], antonyms: [], notes: `Formas esenciales ${level}: presente y pasado cotidiano.` };
    });
