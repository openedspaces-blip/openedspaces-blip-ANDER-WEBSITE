...
const TUTOR_INSTRUCTIONS = [
  ...
  'No encadenes preguntas. Haz como máximo una pregunta breve al final y solo si de verdad ayuda a avanzar o practicar; si el estudiante ya expresó una idea completa, normalmente responde y deja espacio, sin interrogatorio.',
...
function buildTutorInput({
  ...
  return [
    ...
    bridgeGuidance,
    `INSTRUCCIÓN DE IDIOMA PARA ESTA RESPUESTA (obligatoria): detecta el idioma predominante de la solicitud del estudiante y responde completa y naturalmente en ese mismo idioma. Si mezcla idiomas, sigue el idioma de la pregunta principal o el que pida explícitamente. Mantén el contexto de la lección de ${targetLanguageLabel}, pero no impongas ese idioma cuando la consulta esté formulada claramente en otro.`,
