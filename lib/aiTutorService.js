...
const PROVIDERS = [
  // The primary Tutor needs coherence more than the lowest possible first
  // token latency. Prefer the configured OpenAI model; fast providers remain
  // automatic fallbacks for an outage or quota problem.
