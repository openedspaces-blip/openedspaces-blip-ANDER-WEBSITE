...
const LEVEL_RESPONSE_GUIDANCE = {
  A1: 'El estudiante es nivel A1: responde en 60 a 110 palabras, con frases breves y vocabulario sencillo, pero sin dejar la respuesta incompleta - identifica el error, da la versión corregida, explica brevemente por qué y da un ejemplo claro. Apoyo breve en español, con el ejemplo en el idioma meta.',
  A2: 'El estudiante es nivel A2: responde en 60 a 110 palabras, con frases breves y vocabulario sencillo, pero sin dejar la respuesta incompleta - identifica el error, da la versión corregida, explica brevemente por qué y da un ejemplo claro. Apoyo breve en español, con el ejemplo en el idioma meta.',
...
// LEVEL_RESPONSE_GUIDANCE at roughly 2.0 tokens/word plus headroom - A1/A2
// raised from 120 back up alongside LEVEL_RESPONSE_GUIDANCE's 110-word
// ceiling (was 50) so a real explanation/correction/example never gets cut
// off mid-sentence.
