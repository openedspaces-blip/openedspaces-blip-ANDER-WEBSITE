...
// configured. Put the low-latency streaming providers first so the learner
// sees words quickly and the reinforcement cascade can advance without first
// waiting for a whole non-streaming response. OpenAI and Gemini remain solid
// complete-response fallbacks when both streaming providers are unavailable.
const PROVIDERS = [
...
const FIRST_CHUNK_TIMEOUT_MS = 4000;
