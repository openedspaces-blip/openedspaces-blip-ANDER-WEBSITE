...
function buildTutorInput({
  ...
  return [
    ...
    `Lengua nativa del estudiante: ${nativeLanguageLabel}.`,
...
// to trigger indirectly (a misconfigured or rate-limited OpenAI account) -
// the raw OpenAI error message is often too technical or leaks account details.
