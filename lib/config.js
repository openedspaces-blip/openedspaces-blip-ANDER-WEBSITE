...
module.exports = {
  ...
  paddle: {
    environment:
      (process.env.NEXT_PUBLIC_PADDLE_ENV || process.env.PADDLE_ENVIRONMENT) === 'production'
        ? 'production'
        : 'sandbox',
    clientSideToken:
      process.env.NEXT_PUBLIC_PADDLE_CLIENT_TOKEN ||
      process.env.PADDLE_CLIENT_SIDE_TOKEN ||
      '',
    ...
    monthlyPriceId:
      ...
      '',
    quarterlyPriceId:
      process.env.NEXT_PUBLIC_PADDLE_QUARTERLY_PRICE_ID ||
      process.env.PADDLE_QUARTERLY_PRICE_ID ||
      ''
  },
