...
// Free-tier monthly caps (lib/usageLimitService.js) - same calendar-month
// period for both. Premium/ceo bypass both entirely (isPremiumActive).
const FREE_TUTOR_QUERY_MONTHLY_LIMIT = 30;
const FREE_TUTOR_VOICE_MONTHLY_LIMIT = 10;
...
function createServer() {
  ...
  const TRANSLATABLE_LANGUAGES = new Set(['english', 'french', 'spanish', 'german', 'italian']);
