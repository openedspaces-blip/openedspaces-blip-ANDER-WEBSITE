...
const PLANS = Object.freeze({
  free: Object.freeze({
    ...
    features: Object.freeze([
      'Juegos e infografías incluidos',
      'Pruebas incluidas hasta B1',
      'Primeras lecciones de cada nivel disponible según el idioma',
      `Traductor: ${config.translatorMonthlyLimitFree} consultas/mes`,
  ...
  premium: Object.freeze({
    ...
    features: Object.freeze([
      'Acceso completo a todos los niveles disponibles: A1–C2 en English, Español y Français; A1–B1 en Italiano, Português y Deutsch',
      'Reading, Grammar, Vocabulary, Listening, Speaking y Verbos',
      'Lecciones, evaluaciones, juegos y práctica guiada',
      `Traductor: ${config.translatorMonthlyLimitPremium} consultas/mes`,
      'Chat escrito con Tutor IA sin límite',
