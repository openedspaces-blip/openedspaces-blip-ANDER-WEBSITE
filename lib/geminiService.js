      ...
      body: JSON.stringify({
        ...
        ...(maxOutputTokens
          ? {
              generationConfig: {
                maxOutputTokens,
                // gemini-flash-latest "thinks" before answering by default, and that
                // reasoning is billed against maxOutputTokens - with a tight cap for
                // short tutor replies, thinking alone can eat the whole budget and
                // leave nothing (or a mid-sentence cutoff) for the visible answer.
                // A quick conversational reply doesn't need deep reasoning, so turn
                // it off - this also directly helps the tutor's latency target.
