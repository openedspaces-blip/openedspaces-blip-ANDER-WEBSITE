...
async function callGeminiOnce({ input, instructions, model, timeoutMs, maxOutputTokens }) {
...
async function createResponse({ input, instructions, model = DEFAULT_MODEL, maxOutputTokens }) {
  if (!isConfigured()) {
