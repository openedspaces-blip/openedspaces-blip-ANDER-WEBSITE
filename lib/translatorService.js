...
async function translateText({ text, context, sourceLanguage, targetLanguage, targetVariant }) {
  ...
  if (context && String(context).trim()) body.context = String(context).trim().slice(0, 1000);
