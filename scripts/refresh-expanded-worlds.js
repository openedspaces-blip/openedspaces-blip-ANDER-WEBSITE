...
const commonPlans = {
  A1: {
    listening: {
      ...
      intro:
        'Escucha mini conversaciones de bienvenida y detecta quién habla, cómo se llama y de dónde es.',
  ...
  B2: {
    ...
    grammar: {
      ...
      grammar:
        'Si + imperfecto de subjuntivo, condicional, pasiva perifrástica y estilo indirecto.',
      questions: [
  ...
  C1: {
    ...
    grammar: {
      ...
      intro:
        'Observa cómo cambia el tono cuando conviertes verbos en nombres o suavizas afirmaciones.',
...
const languageSpecs = {
  spanish: {
    ...
    lessons: {
      A1: {
        listening: {
          phrases: ['Hola, me llamo...', 'Soy de...', 'Mucho gusto.', 'Me gusta estudiar.'],
          vocabulary: [
            ['Hola', 'Hello'],
            ['nombre', 'name'],
            ['país', 'country'],
          ...
          readingText:
            'Ana llega a una clase nueva. Dice su nombre, cuenta que es de Baní y comenta que le gusta la música.'
        },
        speaking: {
          phrases: ['Me llamo Laura.', 'Vivo en Santiago.', 'Trabajo por la mañana.', '¿Y tú?'],
          vocabulary: [
            ['vivir', 'to live'],
            ['ciudad', 'city'],
            ['estudiante', 'student'],
          ...
          readingText:
            'Carlos se presenta ante su grupo. Explica que vive con su hermana y que estudia por la tarde.'
        },
        reading: {
          phrases: [
            'Tengo veinte años.',
          ...
          readingText:
            'En casa de Julia viven tres personas. Su padre cocina por la noche y ella lee antes de dormir.'
        },
        writing: {
          phrases: [
          ...
          readingText:
            'Marta escribe una tarjeta para su amiga. Cuenta que desayuna temprano y visita el parque después de clases.'
        },
        grammar: {
          phrases: [
            'Es una profesora.',
          ...
          readingText:
            'El aula tiene una mesa grande y dos libros. La profesora es amable y un amigo nuevo llega hoy.'
        },
        vocabulary: {
          phrases: [
          ...
          readingText:
            'Pablo sale con su cuaderno y toma el autobús a la biblioteca. La calle está tranquila y hace sol.'
        }
      },
      A2: {
        listening: {
          ...
          readingText:
            'En la cafetería, Sonia pide un café con leche y una tostada. Luego compra fruta para la cena.'
        },
        speaking: {
          phrases: [
            'Sigue recto.',
          ...
          readingText:
            'Tomás ayuda a una turista. Le dice que cruce la plaza y gire a la izquierda para encontrar la estación.'
        },
        reading: {
          phrases: [
          ...
          readingText:
            'Lucía invita a sus amigos al cine el sábado. Después de la película, todos cenan en un restaurante pequeño.'
        },
        writing: {
          phrases: [
          ...
          readingText:
            'Diego escribe a su prima desde la playa. Le cuenta que visitó un mercado y que va a volver en agosto.'
        },
        grammar: {
          phrases: [
          ...
          readingText:
            'Eva ha terminado la tarea y va a llamar mañana. Dice que el café de hoy es más dulce que el de ayer.'
        },
        vocabulary: {
          phrases: [
            'Compro pan integral.',
          ...
          readingText:
            'Antes de tomar el autobús, Irene pasa por el mercado. Compra pan, pide cambio y prepara sopa al llegar a casa.'
        }
      },
      B1: {
        listening: {
        ...
        speaking: {
          ...
          readingText:
            'En el club de idiomas, Marta opina que dormir bien mejora la concentración. Sus compañeros prefieren hacer ejercicio.'
        },
        reading: {
          phrases: [
          ...
          readingText:
            'Un grupo del barrio organiza talleres de lectura para niños. Gracias al proyecto, más vecinos visitan la biblioteca.'
        },
        writing: {
          phrases: [
        ...
        grammar: {
          ...
          readingText:
            'Mientras Pedro cocinaba, recibió una llamada. Aunque llovía, salió porque tenía que cambiar su plan.'
        },
        vocabulary: {
          phrases: [
          ...
          readingText:
            'El equipo preparó un reportaje sobre un viaje escolar. Reservó el alojamiento con tiempo y cumplió la meta del proyecto.'
        }
      },
      B2: {
        listening: {
          ...
          readingText:
            'En la radio, dos expertos debaten si el trabajo remoto mejora la productividad. Ambos reconocen ventajas, pero discrepan sobre el contacto humano.'
        },
        speaking: {
          phrases: [
          ...
          readingText:
            'El ayuntamiento estudia dos políticas: ampliar los buses o crear ciclovías. Los vecinos comparan costos, rapidez e impacto ambiental.'
        },
        reading: {
          phrases: [
          ...
          readingText:
            'Un reportaje explica cómo varias ciudades limitan el tráfico turístico. Los residentes dicen que la convivencia mejora cuando hay reglas claras.'
        },
        writing: {
          phrases: [
          ...
          readingText:
            'La coordinadora pide propuestas para mejorar la biblioteca. Un grupo sugiere más recursos digitales, mejor iluminación y mantenimiento regular.'
        },
        grammar: {
          phrases: [
          ...
          readingText:
            'El director afirmó que el proceso debía revisarse. Si hubiera más datos, el equipo tomaría una decisión más sólida.'
        },
        vocabulary: {
          phrases: [
          ...
          readingText:
            'Tras la campaña, el debate público creció. La evidencia mostró un impacto desigual, pero permitió alcanzar un acuerdo parcial.'
        }
      },
      C1: {
        listening: {
          ...
          readingText:
            'En un pódcast cultural, la autora explica que la migración transforma la identidad sin borrar la memoria compartida.'
        },
        speaking: {
          phrases: [
          ...
          readingText:
            'Durante un seminario, Elena comparte parte de la propuesta de su colega, pero distingue entre contexto histórico y efecto social.'
        },
        reading: {
          phrases: [
          ...
          readingText:
            'El ensayo sostiene que el lenguaje público organiza la memoria colectiva. A partir de varias metáforas, conecta relato, poder y comunidad.'
        },
        writing: {
          phrases: [
          ...
          readingText:
            'La reseña destaca que el documental formula una pregunta decisiva. También señala una omisión importante en su enfoque.'
        },
        grammar: {
          phrases: [
          ...
          readingText:
            'El informe considera deseable una revisión periódica. Insiste en que se reconozca el problema con un registro preciso y cohesivo.'
        },
        vocabulary: {
          phrases: [
          ...
          readingText:
            'La interpretación del artículo cambia según la perspectiva elegida. Un pequeño matiz modifica el alcance de la conclusión.'
        }
      },
      C2: {
        listening: {
          ...
          readingText:
            'En la entrevista, la experta responde con aparente calma, pero su tono deja entrever una crítica severa al proyecto.'
        },
        speaking: {
          phrases: [
          ...
          readingText:
            'Durante una negociación, la portavoz admite un punto menor para proteger su prioridad central y proponer una salida intermedia.'
        },
        reading: {
          phrases: [
          ...
          vocabulary: [
            ['alusión', 'allusion'],
            ['presupuesto', 'assumption'],
            ['cierre', 'closing'],
            ['interpretación', 'interpretation'],
            ['voz', 'voice']
          ],
          readingText:
            'La crítica presupone un lector experto y usa una alusión histórica para resignificar el cierre del ensayo.'
        },
        writing: {
          phrases: [
          ...
          readingText:
            'El editorial desconfía de las respuestas simples. Propone una mirada más amplia y deja abierta la cuestión central.'
        },
        grammar: {
          phrases: [
          ...
          readingText:
            'Al corregir un ensayo, la editora cambia una referencia ambigua y una elección verbal. Así mejora la cadencia y la cohesión del texto.'
        },
        vocabulary: {
          phrases: [
          ...
          readingText:
            'La crítica examina cómo el sesgo y el registro alteran la interpretación. También valora la elocuencia del autor sin confundirla con exageración.'
        }
      }
    }
  },
  italian: {
    ...
    lessons: {
      A1: {
        listening: {
          phrases: ['Ciao, mi chiamo...', 'Sono di...', 'Piacere.', 'Mi piace studiare.'],
          vocabulary: [
            ['ciao', 'hola'],
            ['nome', 'nombre'],
            ['paese', 'país'],
          ...
          readingText:
            'Anna arriva in una classe nuova. Dice il suo nome, racconta che viene da Bari e che le piace la musica.'
        },
        speaking: {
          phrases: ['Mi chiamo Laura.', 'Abito a Torino.', 'Lavoro la mattina.', 'E tu?'],
          vocabulary: [
            ['abitare', 'vivir'],
            ['città', 'ciudad'],
            ['studente', 'estudiante'],
          ...
          readingText:
            'Carlo si presenta al gruppo. Spiega che vive con sua sorella e che studia nel pomeriggio.'
        },
        reading: {
          phrases: [
            "Ho vent'anni.",
          ...
          readingText:
            'A casa di Giulia vivono tre persone. Suo padre cucina la sera e lei legge prima di dormire.'
        },
        writing: {
          phrases: [
          ...
          readingText:
            "Marta scrive una cartolina a un'amica. Racconta che fa colazione presto e va al parco dopo le lezioni."
        },
        grammar: {
          phrases: [
            "È un'insegnante.",
          ...
          readingText:
            "L'aula ha un tavolo grande e due libri. L'insegnante è gentile e oggi arriva un amico nuovo."
        },
        vocabulary: {
          phrases: [
          ...
          readingText:
            "Paolo esce con il suo quaderno e prende l'autobus per la biblioteca. La strada è tranquilla e c'è il sole."
        }
      },
      A2: {
        listening: {
          ...
          readingText:
            'Al bar, Sonia ordina un caffè con latte e una fetta di pane tostato. Poi compra della frutta per la cena.'
        },
        speaking: {
          phrases: [
            'Vai sempre dritto.',
          ...
          readingText:
            'Tommaso aiuta una turista. Le dice di attraversare la piazza e girare a sinistra per trovare la stazione.'
        },
        reading: {
          phrases: [
          ...
          readingText:
            'Lucia invita i suoi amici al cinema sabato. Dopo il film, tutti cenano in un piccolo ristorante.'
        },
        writing: {
          phrases: [
        ...
        grammar: {
          ...
          readingText:
            'Eva ha finito i compiti e domani farà una telefonata. Dice che il caffè di oggi è più dolce di quello di ieri.'
        },
        vocabulary: {
          phrases: [
          ...
          readingText:
            "Prima di prendere l'autobus, Irene passa dal mercato. Compra il pane, chiede il resto e prepara una zuppa quando torna a casa."
        }
      },
      B1: {
        listening: {
          ...
          vocabulary: [
            ...
            ['riposo', 'descanso'],
            ['priorità', 'prioridad'],
            ['stanchezza', 'cansancio'],
            ['organizzare', 'organizar']
          ],
          readingText:
            'Raul lavorava fino a tardi e arrivava stanco a lezione. Adesso usa un orario fisso e riposa meglio.'
        },
        speaking: {
          phrases: [
          ...
          readingText:
            'Nel club di lingue, Marta dice che dormire bene migliora la concentrazione. I suoi compagni preferiscono fare esercizio.'
        },
        reading: {
          phrases: [
          ...
          readingText:
            'Un gruppo del quartiere organizza laboratori di lettura per bambini. Grazie al progetto, più vicini visitano la biblioteca.'
        },
        writing: {
          phrases: [
          ...
          readingText:
            'Quando Giulia ha cambiato lavoro, ha fatto vari errori. Poco a poco ha chiesto aiuto e alla fine si è sentita orgogliosa dei suoi progressi.'
        },
        grammar: {
          phrases: [
          ...
          readingText:
            'Mentre Pietro cucinava, ha ricevuto una chiamata. Anche se pioveva, è uscito perché doveva cambiare il suo piano.'
        },
        vocabulary: {
          phrases: [
          ...
          readingText:
            "La squadra ha preparato un reportage su un viaggio scolastico. Ha prenotato l'alloggio in anticipo e ha raggiunto l'obiettivo del progetto."
        }
      },
      B2: {
        listening: {
          ...
          readingText:
            "Alla radio, due esperti discutono se il lavoro a distanza migliori la produttività. Entrambi riconoscono vantaggi, ma non sono d'accordo sul contatto umano."
        },
        speaking: {
          phrases: [
          ...
          readingText:
            'Il comune studia due politiche: aumentare gli autobus o creare piste ciclabili. I residenti confrontano costi, velocità e impatto ambientale.'
        },
        reading: {
          phrases: [
          ...
          readingText:
            'Un reportage spiega come varie città limitino il traffico turistico. I residenti dicono che la convivenza migliora quando esistono regole chiare.'
        },
        writing: {
          phrases: [
          ...
          readingText:
            'La coordinatrice chiede proposte per migliorare la biblioteca. Un gruppo suggerisce più risorse digitali, migliore illuminazione e manutenzione regolare.'
        },
        grammar: {
          phrases: [
          ...
          readingText:
            'Il direttore ha affermato che il processo doveva essere rivisto. Se ci fossero più dati, il gruppo prenderebbe una decisione più solida.'
        },
        vocabulary: {
          phrases: [
          ...
          readingText:
            'Dopo la campagna, il dibattito pubblico è cresciuto. La prova ha mostrato un impatto disuguale, ma ha permesso di raggiungere un accordo parziale.'
        }
      },
      C1: {
        listening: {
          ...
          readingText:
            "In un podcast culturale, l'autrice spiega che la migrazione trasforma l'identità senza cancellare la memoria condivisa."
        },
        speaking: {
          phrases: [
          ...
          readingText:
            'Durante un seminario, Elena condivide in parte la proposta della collega, ma distingue tra contesto storico ed effetto sociale.'
        },
        reading: {
          phrases: [
          ...
          readingText:
            'Il saggio sostiene che il linguaggio pubblico organizzi la memoria collettiva. Attraverso varie metafore collega racconto, potere e comunità.'
        },
        writing: {
          phrases: [
          ...
          readingText:
            "La recensione sottolinea che il documentario formula una domanda decisiva. Segnala anche un'omissione importante nel suo approccio."
        },
        grammar: {
          phrases: [
          ...
          readingText:
            'Il rapporto considera desiderabile una revisione periodica. Insiste sul fatto che il problema venga riconosciuto con un registro preciso e coeso.'
        },
        vocabulary: {
          phrases: [
          ...
          readingText:
            "L'interpretazione dell'articolo cambia secondo la prospettiva scelta. Una piccola sfumatura modifica la portata della conclusione."
        }
      },
      C2: {
        listening: {
          ...
          vocabulary: [
            ['ironia', 'ironía'],
            ['insinuazione', 'insinuación'],
            ['tono', 'tono'],
            ['sottotesto', 'subtexto'],
            ['enfasi', 'énfasis']
          ],
          readingText:
            "Nell'intervista, l'esperta risponde con apparente calma, ma il suo tono lascia intravedere una critica severa al progetto."
        },
        speaking: {
          phrases: [
          ...
          readingText:
            'Durante una negoziazione, la portavoce ammette un punto minore per proteggere la priorità centrale e proporre una via intermedia.'
        },
        reading: {
          phrases: [
          ...
          readingText:
            "La critica presuppone un lettore esperto e usa un'allusione storica per risignificare la chiusura del saggio."
        },
        writing: {
          phrases: [
          ...
          readingText:
            "L'editoriale diffida delle risposte semplici. Propone uno sguardo più ampio e lascia aperta la questione centrale."
        },
        grammar: {
          phrases: [
          ...
          vocabulary: [
            ...
            ['senso', 'sentido'],
            ['coesione', 'cohesión'],
            ['autorevolezza', 'autoridad']
          ],
          readingText:
            "Correggendo un saggio, l'editrice cambia un riferimento ambiguo e una scelta verbale. Così migliora la cadenza e la coesione del testo."
        },
        vocabulary: {
          phrases: [
          ...
          readingText:
            "La critica esamina come il pregiudizio e il registro alterino l'interpretazione. Valuta anche l'eloquenza dell'autore senza confonderla con l'esagerazione."
        }
      }
    }
  },
  german: {
    ...
    lessons: {
      A1: {
        listening: {
          phrases: ['Hallo, ich heiße...', 'Ich komme aus...', 'Freut mich.', 'Ich lerne gern.'],
          vocabulary: [
            ['Hallo', 'hola'],
            ['Name', 'nombre'],
            ['Land', 'país'],
          ...
          readingText:
            'Ana kommt in eine neue Klasse. Sie sagt ihren Namen, erzählt, dass sie aus Baní kommt, und dass sie Musik mag.'
        },
        speaking: {
          phrases: [
            'Ich heiße Laura.',
          ...
          readingText:
            'Carlos stellt sich seiner Gruppe vor. Er erklärt, dass er mit seiner Schwester wohnt und am Nachmittag lernt.'
        },
        reading: {
          phrases: [
          ...
          readingText:
            'In Julias Haus leben drei Personen. Ihr Vater kocht am Abend und sie liest vor dem Schlafen.'
        },
        writing: {
          phrases: [
          ...
          readingText:
            'Marta schreibt eine Karte an ihre Freundin. Sie erzählt, dass sie frühstückt und nach dem Unterricht in den Park geht.'
        },
        grammar: {
          phrases: [
            'Sie ist Lehrerin.',
          ...
          readingText:
            'Im Klassenraum gibt es einen großen Tisch und zwei Bücher. Die Lehrerin ist freundlich und heute kommt ein neuer Freund.'
        },
        vocabulary: {
          phrases: [
          ...
          readingText:
            'Paul geht mit seinem Heft aus dem Haus und nimmt den Bus zur Bibliothek. Die Straße ist ruhig und die Sonne scheint.'
        }
      },
      A2: {
        listening: {
          ...
          readingText:
            'Im Café bestellt Sonia einen Kaffee mit Milch und einen Toast. Danach kauft sie Obst für das Abendessen.'
        },
        speaking: {
          phrases: [
            'Geh geradeaus.',
          ...
          readingText:
            'Tomás hilft einer Touristin. Er sagt ihr, dass sie über den Platz gehen und links abbiegen soll, um den Bahnhof zu finden.'
        },
        reading: {
          phrases: [
          ...
          readingText:
            'Lucía lädt ihre Freunde am Samstag ins Kino ein. Nach dem Film essen alle in einem kleinen Restaurant zu Abend.'
        },
        writing: {
          phrases: [
        ...
        grammar: {
          ...
          readingText:
            'Eva hat die Hausaufgabe beendet und wird morgen anrufen. Sie sagt, dass der Kaffee von heute süßer ist als der von gestern.'
        },
        vocabulary: {
          phrases: [
          ...
          readingText:
            'Bevor Irene den Bus nimmt, geht sie über den Markt. Sie kauft Brot, bittet um Wechselgeld und kocht zu Hause eine Suppe.'
        }
      },
      B1: {
        listening: {
          ...
          readingText:
            'Raúl arbeitete bis spät und kam müde zum Unterricht. Jetzt benutzt er einen festen Zeitplan und ruht sich besser aus.'
        },
        speaking: {
          phrases: [
          ...
          readingText:
            'Im Sprachklub sagt Marta, dass guter Schlaf die Konzentration verbessert. Ihre Freunde machen lieber Sport.'
        },
        reading: {
          phrases: [
          ...
          readingText:
            'Eine Gruppe aus dem Stadtviertel organisiert Lese-Workshops für Kinder. Dank des Projekts besuchen mehr Nachbarn die Bibliothek.'
        },
        writing: {
          phrases: [
          ...
          readingText:
            'Als Julia den Job wechselte, machte sie einige Fehler. Nach und nach bat sie um Hilfe und war am Ende stolz auf ihren Fortschritt.'
        },
        grammar: {
          phrases: [
          ...
          readingText:
            'Während Pedro kochte, bekam er einen Anruf. Obwohl es regnete, ging er hinaus, weil er seinen Plan ändern musste.'
        },
        vocabulary: {
          phrases: [
          ...
          readingText:
            'Das Team bereitete eine Reportage über eine Schulreise vor. Es reservierte die Unterkunft früh und erreichte das Ziel des Projekts.'
        }
      },
      B2: {
        listening: {
          ...
          readingText:
            'Im Radio diskutieren zwei Experten, ob Heimarbeit die Produktivität verbessert. Beide sehen Vorteile, aber sie streiten über den menschlichen Kontakt.'
        },
        speaking: {
          phrases: [
        ...
        reading: {
          ...
          readingText:
            'Ein Bericht erklärt, wie mehrere Städte den touristischen Verkehr einschränken. Die Bewohner sagen, dass klare Regeln das Zusammenleben verbessern.'
        },
        writing: {
          phrases: [
          ...
          readingText:
            'Die Koordinatorin bittet um Vorschläge zur Verbesserung der Bibliothek. Eine Gruppe schlägt mehr digitale Ressourcen, besseres Licht und regelmäßige Wartung vor.'
        },
        grammar: {
          phrases: [
          ...
          readingText:
            'Der Direktor sagte, dass der Prozess überprüft werden müsse. Wenn es mehr Daten gäbe, würde das Team eine stärkere Entscheidung treffen.'
        },
        vocabulary: {
          phrases: [
          ...
          readingText:
            'Nach der Kampagne wuchs die öffentliche Debatte. Die Evidenz zeigte ungleiche Auswirkungen, half aber dabei, eine teilweise Einigung zu erzielen.'
        }
      },
      C1: {
        listening: {
          ...
          readingText:
            'In einem Kulturpodcast erklärt die Autorin, dass Migration die Identität verändert, ohne das gemeinsame Gedächtnis zu löschen.'
        },
        speaking: {
          phrases: [
          ...
          readingText:
            'Während eines Seminars stimmt Elena einem Teil des Vorschlags zu, unterscheidet aber sorgfältig zwischen historischem Kontext und sozialer Wirkung.'
        },
        reading: {
          phrases: [
          ...
          readingText:
            'Der Essay behauptet, dass öffentliche Sprache das kollektive Gedächtnis organisiert. Mit mehreren Metaphern verbindet er Erzählung, Macht und Gemeinschaft.'
        },
        writing: {
          phrases: [
          ...
          readingText:
            'Die Rezension betont, dass der Dokumentarfilm eine entscheidende Frage stellt. Sie weist auch auf eine wichtige Auslassung im Ansatz hin.'
        },
        grammar: {
          phrases: [
          ...
          readingText:
            'Der Bericht hält eine regelmäßige Überprüfung für wünschenswert. Er betont, dass das Problem in einem präzisen und kohäsiven Register anerkannt werden muss.'
        },
        vocabulary: {
          phrases: [
      ...
      C2: {
        listening: {
          ...
          readingText:
            'Im Interview antwortet die Expertin mit scheinbarer Ruhe, doch ihr Ton lässt eine harte Kritik am Projekt erkennen.'
        },
        speaking: {
          phrases: [
          ...
          readingText:
            'Während einer Verhandlung gibt die Sprecherin einen Nebenpunkt zu, um ihre Hauptpriorität zu schützen und einen Mittelweg vorzuschlagen.'
        },
        reading: {
          phrases: [
          ...
          vocabulary: [
            ['Anspielung', 'alusión'],
            ['Voraussetzung', 'supuesto'],
            ['Schluss', 'cierre'],
            ['Deutung', 'interpretación'],
            ['Stimme', 'voz']
          ],
          readingText:
            'Die Kritik setzt einen kundigen Leser voraus und nutzt eine historische Anspielung, um den Schluss des Essays neu zu deuten.'
        },
        writing: {
          phrases: [
          ...
          readingText:
            'Der Leitartikel misstraut einfachen Antworten. Er fordert einen weiteren Blick und lässt die zentrale Frage offen.'
        },
        grammar: {
          phrases: [
          ...
          readingText:
            'Beim Überarbeiten eines Essays ändert die Redakteurin einen unklaren Bezug und eine Wortwahl. So verbessert sie Rhythmus und Kohäsion des Textes.'
        },
        vocabulary: {
          phrases: [
          ...
          vocabulary: [
            ['Voreingenommenheit', 'sesgo'],
            ['Beredsamkeit', 'elocuencia'],
            ['Nuance', 'matiz'],
            ['Register', 'registro'],
            ['Überzeugungskraft', 'persuasión']
          ],
          readingText:
            'Die Kritik untersucht, wie Voreingenommenheit und Register die Deutung verändern. Sie würdigt auch die Beredsamkeit des Autors, ohne sie mit Übertreibung zu verwechseln.'
        }
      }
    }
  }
...
function buildDialogue(languageKey, phrases) {
  const translations =
    languageKey === 'spanish'
      ? ['Model line', 'Guided reply']
      : ['Frase modelo', 'Respuesta guiada'];
  return [
...
const retained = seed.filter(
  (row) => !['spanish', 'italian', 'german'].includes(row.target_language)
);
