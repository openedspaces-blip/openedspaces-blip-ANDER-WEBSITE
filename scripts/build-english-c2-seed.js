...
function row(unit,skill,index){
  ...
  return {slug:`english-c2-${unit.slug}-${skill}`,target_language:language,level,skill,unit_slug:unit.slug,title:a.title,description:a.description||'',order_index:unit.order*10+index,estimated_minutes:a.duration,is_free:unit.accessTier!=='premium',access_tier:unit.accessTier,content_json:{language:'English',language_key:language,level_title:courseTitle,grammar:a.grammarNote||'',phrases:a.phrases||[],vocabulary:a.vocabulary||[],reading:a.reading||null,exercises:a.exercises||[],extra:Object.keys(extra).length?extra:null,xp_reward:a.xp}};
}
