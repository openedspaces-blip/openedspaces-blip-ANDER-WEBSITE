  ...
  // ---------------------------------------------------------------
  {
    ...
    activities: {
      reading: activity('reading', {
        ...
        exercises: [
          { type: 'mcq', prompt: 'What is the teacher\'s name?', options: ['Mr. Green', 'Mr. Leo', 'Mr. Ana', 'Mr. Class'], answer: 0 },
          { type: 'mcq', prompt: 'Who sits next to Ana?', options: ['Mr. Green', 'Leo', 'Sofia', 'Marco'], answer: 1 },
          { type: 'mcq', prompt: 'What do they practice with the alphabet?', options: ['Numbers', 'Spelling their names', 'Colors', 'Drawing'], answer: 1 }
        ]
      }),
    ...
    activities: {
      reading: activity('reading', {
        ...
        exercises: [
          ...
          { type: 'mcq', prompt: 'What does she do after school?', options: ['She sleeps', 'She eats breakfast', 'She does homework and plays', 'She goes to work'], answer: 2 },
          { type: 'mcq', prompt: 'What time does she go to bed?', options: ['Seven o\'clock', 'Eight thirty', 'Nine o\'clock', 'Nine thirty'], answer: 3 }
        ]
      }),
      listening: activity('listening', {
