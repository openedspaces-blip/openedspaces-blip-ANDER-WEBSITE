...
const plans = [
  {
    ...
    parts: [
      'En 2023, l’annonce d’une réforme du financement des universités françaises a donné lieu à des comptes rendus radicalement différents selon les rédactions. Un quotidien national a mis en avant la modernisation promise par le ministère, insistant sur la souplesse administrative accordée aux établissements. Un média étudiant a surtout documenté la précarisation redoutée par les personnels et les usagers, ouvrant son article sur le témoignage d’une étudiante contrainte de travailler la nuit pour financer ses études. Une chronique économique, de son côté, a présenté la mesure comme une rationalisation budgétaire devenue inévitable. Les trois articles citaient les mêmes chiffres officiels, mais aucun ne racontait tout à fait la même histoire.',
      'Une analyse comparée de ces trois textes révèle d’abord un contraste lexical révélateur : là où le communiqué ministériel parlait d’« autonomie renforcée », le média étudiant évoquait un « désengagement financier » de l’État. Ce décalage ne prouve pas qu’un article mente délibérément. Il montre plutôt que sélectionner, ordonner et nommer les faits revient déjà à leur donner une orientation, un phénomène que les chercheurs en sciences de l’information désignent sous le terme de cadrage, ou framing.',
      'Il convient cependant de ne pas transformer ce constat en procès d’intention généralisé. Les rédactions travaillent sous contraintes de temps et d’espace, s’adressent à des publics différents et s’appuient sur des lignes éditoriales identifiables et assumées. Ce qui importe pour un lecteur exigeant est de distinguer une perspective éditoriale assumée d’une manipulation qui, elle, dissimule ses propres procédés. Un tableau comparatif utile retiendrait ainsi, pour chaque article, les sources citées, les voix absentes, le degré de contextualisation des données et le niveau de certitude affiché dans les affirmations.',
      'On ne saurait, en conclusion, désigner un seul de ces articles comme définitivement neutre. Une lecture informée exige plutôt de croiser plusieurs récits et d’en observer les angles morts respectifs. Cette prudence méthodologique ne conduit pas pour autant au relativisme : certains faits demeurent vérifiables et certaines affirmations sont indiscutablement mieux étayées que d’autres. L’esprit critique, en somme, ne consiste pas seulement à douter systématiquement, mais à se demander comment chaque version du réel a été construite, et dans quel but.'
    ],
    vocabulary: [
    ...
    readingChecks: [
      ...
      ['Quelle opposition lexicale l’analyse comparée révèle-t-elle ?', ['Autonomie renforcée / désengagement financier', 'Réforme / université', 'Étudiante / ministre', 'Économie / chronique'], 0],
      ['Pourquoi le texte met-il en garde contre le procès d’intention ?', ['Il considère tous les médias neutres', 'Une perspective éditoriale ne prouve pas automatiquement une manipulation', 'Il défend le ministère', 'Il refuse toute analyse critique'], 1],
      ['Que doit contenir un tableau comparatif utile, selon le texte ?', ['Le prix des journaux', 'Les sources, les voix absentes et le degré de certitude', 'Le nombre de lecteurs seulement', 'La longueur des titres'], 1],
  ...
  },
  {
    ...
    parts: [
      'Un extrait où une autrice caribéenne mêle français standard, créole et souvenirs familiaux constitue un cas d’étude révélateur des limites actuelles de la traduction automatique neuronale. Soumis à un outil de traduction en ligne, un tel passage produit un résultat grammaticalement impeccable, fluide et quasi instantané. Pourtant, quelque chose s’y aplatit systématiquement : les hésitations de la narratrice disparaissent, une expression créole devient une formule neutre et l’ironie d’une phrase se transforme en affirmation sérieuse.',
      'Les défenseurs de ces outils rappellent, à juste titre, le temps qu’ils permettent de gagner. Pour des documents répétitifs, des notices techniques ou une première compréhension globale, leur utilité paraît difficilement contestable. Le problème se situe ailleurs : dans le glissement qui consiste à confondre une traduction acceptable avec une traduction fidèle à une voix. Une phrase peut transmettre une information correcte tout en modifiant profondément la relation que le texte entretient avec son lecteur.',
      'Des ateliers de traduction littéraire comparent régulièrement trois versions d’un même extrait : celle de la machine, celle d’un traducteur humain et une version collective issue de la discussion. Le débat ne porte alors plus sur des erreurs évidentes, mais sur de véritables décisions interprétatives. Faut-il conserver le mot créole et ajouter une note en bas de page ? Reproduire une syntaxe inhabituelle, au risque de troubler le lecteur ? Rendre explicite une allusion culturelle que le texte original laisse volontairement implicite ?',
      'On peut en conclure que la technologie ne supprime pas la responsabilité du traducteur ; elle la déplace. Plus l’outil produit un texte vraisemblable, plus la vigilance humaine doit porter sur ce qui ne se voit pas immédiatement : le rythme, le sous-entendu et la position de la voix narrative. Quand bien même les systèmes deviendraient plus performants dans les années à venir, choisir entre plusieurs fidélités resterait un acte humain, discutable et toujours situé dans un contexte particulier.'
    ],
    vocabulary: [
    ...
    readingChecks: [
      ...
      ['Sur quel point les défenseurs de l’outil insistent-ils ?', ['Sa créativité littéraire', 'Le gain de temps', 'Sa connaissance du créole', 'Son absence totale d’erreurs'], 1],
      ['Quelle confusion le texte critique-t-il ?', ['Traduction et écriture', 'Acceptabilité et fidélité à une voix', 'Français et créole', 'Atelier et examen'], 1],
      ['Pourquoi la version collective d’un atelier est-elle utile ?', ['Elle élimine tout désaccord', 'Elle rend visibles les choix interprétatifs', 'Elle copie la machine', 'Elle raccourcit le texte'], 1],
  ...
  },
  {
    ...
    parts: [
      'Les historiens de la migration accordent depuis une trentaine d’années une attention croissante aux correspondances familiales comme sources documentaires. Des milliers de lettres échangées entre des personnes parties travailler en Europe dans les années soixante et soixante-dix, aujourd’hui conservées dans des boîtes d’archives privées ou déposées dans des centres de recherche, permettent de reconstituer des parcours nettement moins linéaires que ceux que les récits familiaux ont coutume de résumer en quelques mots : on partait, on réussissait, puis on revenait. Ces lettres révèlent au contraire des trajectoires traversées par la solitude, les emplois précaires et la crainte de décevoir des proches qui attendaient des nouvelles rassurantes.',
      ...
      'En croisant lettres, archives administratives et entretiens, ces travaux de recherche invitent à abandonner l’idée d’une origine simple qui expliquerait entièrement une identité. Ils font apparaître plutôt une constellation de départs, d’attachements et de récits sans cesse révisés. Une histoire familiale migratoire, une fois documentée avec cette rigueur, ne dicte aucune identité définitive : elle offre des questions plus précises et impose une responsabilité, celle de transmettre les sources sans effacer leurs contradictions.'
    ],
    vocabulary: [
    ...
    readingChecks: [
      ['Quelle version familiale ces correspondances compliquent-elles habituellement ?', ['Un départ sans retour', 'Un parcours simple de réussite puis de retour', 'Une histoire universitaire', 'Un conflit politique'], 1],
      ['Quel détail contredit « tout va pour le mieux » dans le corpus étudié ?', ['Une date erronée', 'La demande discrète d’un remède', 'Un changement de nom', 'Une photographie'], 1],
      ['Pourquoi les témoignages oraux restent-ils utiles malgré leurs hésitations ?', ['Ils remplacent les lettres', 'Ils apportent un contexte tout en révélant leurs propres limites', 'Ils garantissent chaque date', 'Ils suppriment les silences'], 1],
      ['Que devient le silence pour les historiens, selon le texte ?', ['Une preuve certaine', 'Une donnée à interpréter avec prudence', 'Une erreur à supprimer', 'Un passage inutile'], 1],
      ['Comment ces travaux invitent-ils à reconsidérer l’identité ?', ['En cherchant une origine unique', 'En acceptant une pluralité de récits contradictoires', 'En rejetant l’histoire familiale', 'En adoptant uniquement le récit officiel'], 1],
  ...
  },
  {
    ...
    readingChecks: [
      ...
      ['Que craignent les défenseurs les plus fermes du mérite ?', ['La suppression des examens', 'Qu’une analyse des inégalités décourage l’effort', 'La hausse des transports', 'La simplification des dossiers'], 1],
      ['Quelle nuance le texte apporte-t-il à cette crainte ?', ['Effort et conditions sociales peuvent être analysés ensemble', 'Toute difficulté vient de la volonté', 'Le mérite est inutile', 'Les circonstances expliquent absolument tout'], 0],
  ...
  },
  {
    ...
    parts: [
      'De nombreux établissements d’enseignement supérieur français se sont fixé, ces dernières années, un objectif ambitieux : réduire de moitié leurs émissions de gaz à effet de serre en dix ans. Les premières propositions paraissent souvent simples — baisser le chauffage, limiter les déplacements, fermer certains bâtiments le soir — jusqu’à ce que les usagers en décrivent les conséquences concrètes. Une bibliothèque ouverte tard accueille ceux qui ne peuvent pas travailler chez eux ; certaines formations exigent des laboratoires par nature énergivores ; les étudiants les plus éloignés dépendent de réseaux de transport encore peu fréquents.',
  ...
  },
  {
    ...
    readingChecks: [
      ['Selon le texte, qu’est-ce qui pose réellement problème dans la correction d’un accent régional ?', ['La prononciation empêche la compréhension', 'L’association implicite entre accent et manque de compétence', 'L’accent n’existe pas vraiment', 'Personne ne corrige jamais les accents'], 1],
      ['Quelle distinction établissent les travaux cités ?', ['Accent et grammaire', 'Convention contextuelle et supériorité naturelle supposée', 'Écrit et oral uniquement', 'Français et espagnol'], 1],
      ...
      ['Comment le texte redéfinit-il la maîtrise linguistique des locuteurs bilingues ?', ['Effacer son origine', 'Pouvoir choisir entre plusieurs registres', 'Refuser le français standard', 'Imiter tous les accents'], 1],
      ['Que prévoit une charte linguistique scolaire, selon le texte ?', ['Ne jamais corriger', 'Corriger pour la compréhension sans humilier', 'Imposer un accent unique', 'Supprimer les registres'], 1],
  ...
  },
  {
    ...
    parts: [
      'Ce type de controverse s’est répété à plusieurs reprises dans des établissements culturels français ces dernières années : une semaine avant son ouverture, une exposition consacrée aux frontières et aux migrations est retirée du programme. Le communiqué de la direction invoque généralement un risque de conflit, sans préciser quelles œuvres posent réellement problème. Les enquêtes journalistiques menées sur ce type d’affaire interrogent la direction, les artistes concernés et les associations qui formulent des critiques souvent opposées : l’une juge une installation offensante, l’autre considère son retrait comme une forme de censure.',
      'Dans un cas emblématique documenté par la presse culturelle, l’artiste concernée expliquait que son œuvre reproduisait des formulaires administratifs sur lesquels des phrases personnelles avaient été brodées, afin de montrer comment une existence complexe se trouve réduite à de simples cases à cocher. Une association de défense des migrants estimait cependant que l’installation utilisait des témoignages sans leur donner assez de contexte. Une telle critique ne demande pas nécessairement l’interdiction de l’œuvre ; elle questionne plutôt la manière dont la souffrance d’autrui devient matériau artistique.',
      'Les directions d’établissements affirment le plus souvent avoir simplement reporté une exposition pour permettre une médiation entre les parties. Il arrive pourtant que les artistes ne reçoivent ensuite ni nouveau calendrier ni proposition précise. Le mot « report » semble alors fonctionner comme un adoucissement purement administratif d’une annulation de fait. Il convient malgré tout de ne pas réduire ce type d’affaire à un affrontement entre courageux créateurs et bureaucrates hostiles : les objections éthiques méritent une réponse argumentée, mais une décision opaque empêche justement cette discussion nécessaire.',
      'Une issue régulièrement recommandée par les médiateurs culturels consiste à présenter l’œuvre accompagnée des critiques qu’elle suscite, à documenter l’origine des témoignages utilisés et à organiser un débat public autour de l’exposition elle-même. La liberté artistique ne garantit pas l’absence de contestation ; elle suppose que la contestation puisse répondre à l’œuvre sans la faire disparaître silencieusement. Dans plusieurs cas ainsi résolus, l’exposition finalement présentée n’était plus tout à fait la même : elle incluait désormais le conflit dont elle avait été l’objet.'
    ],
    vocabulary: [
    ...
    readingChecks: [
      ...
      ['Quelle fausse opposition le texte invite-t-il à éviter ?', ['Art et broderie', 'Créateurs courageux contre bureaucrates hostiles', 'Étudiants et associations', 'Formulaires et témoignages'], 1],
  ...
  },
  {
    ...
    readingChecks: [
      ['Pourquoi ce type d’offre de mobilité est-il souvent difficile à accepter ?', ['Le programme n’intéresse personne', 'Elle implique de quitter un réseau enfin solide', 'Le stage est systématiquement annulé', 'La destination est toujours proche'], 1],
      ['Pourquoi le tableau rationnel ne suffit-il pas, selon le texte ?', ['Il manque toujours des chiffres', 'Certaines valeurs ne sont pas directement comparables', 'Personne ne sait le remplir', 'Les conseillers le détruisent'], 1],
      ['Quel biais les chercheurs en sciences de la décision identifient-ils ?', ['Vouloir une option sans aucune perte', 'Vouloir partir à tout prix', 'Vouloir rester travailler', 'Vouloir consulter des étudiants'], 0],
      ['Quelle distinction réduit la dramatisation du choix ?', ['Cher et gratuit', 'Irréversible et révisable', 'France et Canada', 'Études et stage'], 1],
      ['Pourquoi un délai de réflexion aide-t-il souvent à trancher ?', ['Toute incertitude finit par disparaître', 'On sait mieux quelles incertitudes on accepte', 'Les amis imposent une décision', 'La destination perd son intérêt'], 1],
  ...
  },
  {
    ...
    parts: [
      ...
      'Cette réponse rassemble des expériences qui semblaient jusque-là séparées, sans transformer un parcours individuel en modèle universel : elle en dégage plutôt une manière de regarder. Au terme de ce type d’atelier, les nouveaux étudiants repartent généralement sans liste définitive, mais avec des questions qu’ils pourront adapter à leur propre situation. Transmettre une expérience de mobilité, en définitive, ne consiste pas à faire reproduire son propre chemin aux autres, mais à leur donner des outils pour reconnaître le leur.'
    ],
    vocabulary: [
    ...
    readingChecks: [
      ['Pourquoi le titre initial de l’atelier est-il critiqué dans le texte ?', ['Il est trop long', 'Il suggère un parcours uniforme et mesurable', 'Il est en espagnol', 'Il exclut les professeurs'], 1],
      ['Comment les meilleurs ateliers sont-ils organisés, selon le texte ?', ['Avec des règles fixes', 'Autour de situations et réponses conditionnelles', 'Avec un examen', 'Autour d’un CV'], 1],
      ['Pourquoi le mot « attention » revient-il souvent chez ces intervenants ?', ['Il est plus facile à traduire', 'Il relie des apprentissages issus de plusieurs domaines', 'Il résume uniquement la langue', 'Il évite toute réflexion'], 1],
      ['Que ces intervenants refusent-ils de faire de leur parcours ?', ['Le raconter', 'Le transformer en modèle universel', 'Le partager', 'Le relier aux documents'], 1],
...
function expandedParts(plan) {
  ...
  return [
    ...plan.parts,
    `Pour approfondir la question, une analyse rigoureuse distingue généralement trois niveaux souvent confondus : les faits observables, l’interprétation qu’on en propose et les valeurs au nom desquelles on juge la situation. Cette méthode oblige à préciser ses termes. ${sentenceCase(term1)} ne peut plus servir de formule vague ; ${term2} doit être relié à un exemple, et ${term3} à une conséquence vérifiable. Un débat devient plus fécond dès que les participants cessent de défendre une conclusion globale et examinent séparément les prémisses qui la soutiennent. Ils ne parviennent pas toujours au même jugement, mais ils comprennent mieux le point exact où leurs raisonnements se séparent.`,
    `Cette méthode modifie aussi la position de chacun face à ses propres certitudes. On entre souvent dans une discussion avec une intuition forte, que l’on prend presque pour une évidence. En confrontant cette intuition aux objections, on ne l’abandonne pas nécessairement ; on apprend à en limiter la portée et à reconnaître ce qu’elle ne permet pas d’affirmer. ${sentenceCase(term4)} devient ainsi moins un mot à mémoriser qu’un outil pour penser. Une synthèse rigoureuse conserve alors les tensions au lieu de les résoudre artificiellement. Cette capacité à articuler des données, des voix et des incertitudes constitue, en définitive, une véritable méthode de lecture critique.`
  ];
}
