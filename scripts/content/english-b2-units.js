// English B2: evidence-led social-issue readings, written in an editorial
// voice rather than through a recurring fictional storyline.
// Scope: 12 units, Reading + Vocabulary + Grammar.
const topics = [
  ['social-media-public-opinion','Social Media and Public Opinion','Why Misinformation Spreads','An evidence-led examination of why misleading information often travels faster than corrections.','algorithms reward emotional reactions','platforms also help ignored voices reach an audience','media literacy and transparent moderation',['viral','misleading','echo chamber','fact-check','source','bias','moderation','public opinion'],'Passive reporting structures'],
  ['plastic-pollution-cities','Plastic Pollution in Our Cities','Why Clean-ups Are Not Enough','An investigation into the systems behind plastic waste in urban areas.','single-use packaging creates costs that communities carry','plastic remains useful in medicine and food safety','reduce unnecessary use while redesigning systems',['single-use','waste stream','microplastic','reusable','landfill','packaging','clean-up','producer responsibility'],'Causative and passive forms'],
  ['climate-change-daily-decisions','Climate Change and Everyday Decisions','Personal Choices and Public Systems','A comparison of household decisions, public infrastructure and climate policy.','individual choices can influence habits and demand','personal responsibility can distract from major emitters','combine credible personal action with structural policy',['carbon footprint','emissions','renewable','adaptation','mitigation','fossil fuel','incentive','infrastructure'],'Mixed conditionals'],
  ...
  ['fourth-of-july','The Fourth of July: Freedom and Contradictions','Celebration, Memory and Citizenship','An examination of how national celebrations can hold pride and criticism together.','the holiday commemorates independence and shared ideals','the promise of freedom was historically distributed unequally','celebrate achievement while examining unfinished work',['independence','founding document','civil rights','patriotism','commemorate','contradiction','liberty','national identity'],'Participle clauses'],
  ['migration-cultural-identity','Migration and Cultural Identity','Belonging Across Borders','An article on layered identities, cultural continuity and participation in a shared society.','migration creates layered identities and new communities','integration debates often demand a false choice between cultures','belonging can be multiple without being superficial',['belonging','heritage','integration','assimilation','diaspora','identity','host community','roots'],'Advanced relative clauses'],
  ['housing-inequality','Housing Inequality','Housing Costs and Unequal Access','An analysis of supply, affordability, displacement and tenant protection.','limited supply and investment pressure raise prices','development can help but may displace existing residents','build more housing with tenant protection and planning',['affordable housing','rent increase','tenant','landlord','shortage','displacement','zoning','cost of living'],'Comparatives with modifiers'],
  ['ai-and-employment','Artificial Intelligence and Employment','Automation, Work and Accountability','A report on the benefits, risks and governance of automated workplace systems.','automation can remove repetitive work and improve planning','opaque systems can reproduce bias and weaken worker control','human oversight, explanation and retraining',['automation','algorithmic bias','oversight','retraining','productivity','displacement','decision-making','transparent system'],'Future perfect and future continuous'],
  ['fast-fashion-hidden-costs','Fast Fashion and Hidden Costs','The Price Behind Cheap Fashion','An investigation into supply chains, labour conditions and environmental costs.','low prices make fashion accessible','hidden labour and environmental costs are shifted elsewhere','buy less, demand traceability and improve regulation',['fast fashion','supply chain','garment worker','traceability','disposable','labour rights','consumer demand','hidden cost'],'Concession clauses'],
  ['education-social-mobility','Education and Social Mobility','Opportunity, Merit and Support','An analysis of the practical barriers that shape educational opportunity.','education can expand opportunity','access depends on money, information and institutional support','combine high expectations with practical access',['social mobility','scholarship','tuition','mentoring','barrier','opportunity gap','merit','access'],'Inversion for emphasis'],
  ['free-speech-misinformation','Freedom of Speech and Misinformation','Speech, Harm and Moderation','An article on how clear rules can protect debate while limiting measurable harm.','free expression protects disagreement and accountability','unchecked misinformation can cause measurable harm','use clear rules, proportionate action and appeal processes',['free speech','misinformation','censorship','harmful claim','appeal','evidence','content policy','proportionate'],'Reported speech and reporting verbs'],
  ['community-action','Community Action and Local Change','From Complaints to Public Action','A feature on the relationship between local knowledge and institutional responsibility.','local action produces visible knowledge and trust','volunteers cannot replace adequately funded public services','connect community initiative with institutional responsibility',['grassroots','volunteer','petition','stakeholder','local council','initiative','public service','collective action'],'Emphatic cleft structures']
];
...
function buildReading(t) {
  ...
  return [
    `${title} is often discussed through striking examples, but a responsible account begins by separating an individual case from the wider system around it. The available evidence points to a concrete public question: how are decisions made, who experiences their consequences, and which assumptions shape the first explanation people hear?`,
    `One position argues that ${claim}. Supporters can point to practical evidence, yet the strength of that evidence depends on what has been measured, whose experience has been included and whether a short-term result can be treated as a long-term pattern. A persuasive example is not automatically a complete explanation.`,
    `A competing position holds that ${counter}. This objection does not cancel the first claim; it tests its limits. It asks whether costs have been shifted elsewhere, whether some groups have less choice than others, and whether a solution that appears efficient in one context produces a different result in another.`,
    `The most useful reporting therefore compares sources, distinguishes correlation from cause and makes uncertainty visible. It also avoids turning a social issue into a simple moral story about one consumer, worker, institution or community. Evidence has to be interpreted alongside rules, incentives and unequal access to information or resources.`,
    `A defensible direction is to ${conclusion}. This is not a final answer that removes disagreement. It is a proposal that can be assessed against clear criteria: transparency, fairness, practical effect and the quality of the evidence available. If stronger evidence changes the balance of reasons, the conclusion should change with it.`
  ].join('\n\n');

  /* Legacy case-study notes remain as a research archive and are deliberately
     not used in learner-facing readings. */
...
function buildUnit(t,index){
  ...
  const readingExercises=[
    ...
    q('How does the article evaluate the debate?',['It chooses the loudest speaker','It compares sources, facts and assumptions','It avoids all disagreement','It accepts every prediction'],1),
  ...
  const description = `An evidence-led reading on ${title.toLowerCase()}, examining competing claims, consequences and possible responses.`;
  return {slug,title,titleEs:title,description,order:index+1,accessTier:index<2?'free':'premium',unitOverview:{objective:`Evaluate arguments about ${title.toLowerCase()}.`,outcomes:['identify a writer’s position','evaluate evidence and counterarguments','use topic vocabulary','apply advanced grammar'],grammar:[grammar],vocabulary:words.slice(0,4),scenario:description},activities:{
    reading:activity('reading',{title:readingTitle,description,reading:{title:readingTitle,text,questions:[
      ...
      `Why does the article support the following direction: ${conclusion}?`,
