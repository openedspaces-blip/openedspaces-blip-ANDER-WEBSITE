...
// Covers real-world, non-fictional editorial topics: reverse culture shock,
// university admissions, screen-time research, remote work, francophone
// literature, cinema, ethics, AI and the labor market, shared Hispaniola
// history, mangrove conservation, art and identity, and study-abroad
// outcomes, at B2-level argumentative depth (society, literature, ethics,
// science, the arts).
//
...
const units = [
  // ---------------------------------------------------------------
  {
    ...
    activities: {
      reading: activity('reading', {
        ...
        description: 'Une jeune femme revient dans son pays après un an à l’étranger et retrouve sa famille et ses amis.',
        reading: {
          title: 'L’aéroport des retrouvailles',
          parts: [
            "Quand l'avion atterrit à Saint-Domingue, elle sent son cœur battre plus vite qu'à l'accoutumée. Un an s'était écoulé depuis son départ, et elle avait presque oublié à quel point la chaleur humide des Caraïbes pouvait la saisir dès la sortie de l'appareil. En traversant le hall des arrivées, elle aperçoit une pancarte tenue par sa petite sœur : « Bienvenue chez toi ! », avec des fautes d'orthographe qui la font sourire aux larmes. Sa mère, son père et sa meilleure amie l'attendent également, tous les quatre agitant les bras avec un enthousiasme qu'elle avait presque oublié.",
            "Les retrouvailles sont un mélange étrange d'émotions. D'un côté, elle ressent une joie immense de serrer sa famille dans ses bras après tant de mois passés à communiquer uniquement par écran interposé. De l'autre, elle a l'étrange sensation d'être devenue, en quelque sorte, une étrangère dans son propre pays. Son amie le remarque immédiatement : « Tu parles différemment maintenant, tu fais des pauses bizarres, comme si tu traduisais dans ta tête avant de parler espagnol ! » Elle rit, un peu gênée, mais elle sait que son amie a raison : après un an immergée dans une autre langue et une autre culture, quelque chose en elle a changé, sans qu'elle sache exactement quoi.",
            "Dans la voiture qui les ramène à la maison, elle observe par la fenêtre les rues qu'elle connaissait par cœur avant son départ. Tout lui semble à la fois familier et légèrement différent, comme si elle regardait sa propre vie à travers un objectif légèrement décalé. Elle se surprend à comparer inconsciemment : la façon dont on klaxonne dans la circulation, l'odeur de la cuisine dominicaine qui s'échappe des fenêtres ouvertes, la musique qui joue plus fort que dans les rues tranquilles de la ville française où elle a vécu. Elle n'avait pas anticipé que revenir chez elle demanderait, lui aussi, un temps d'adaptation, presque comme si elle avait deux maisons désormais, et qu'aucune des deux ne lui appartenait plus complètement.",
            "Ce soir-là, allongée dans son ancienne chambre restée exactement comme elle l'avait laissée, elle repense à une dernière conversation avec une amie avant de partir. « Tu vas voir, lui avait-on dit, revenir chez toi ne sera pas aussi simple que tu le penses. » Sur le moment, elle n'avait pas vraiment compris ce que son amie voulait dire. Maintenant, allongée dans le noir, elle comprend enfin : elle n'est plus tout à fait la même personne qui était partie un an plus tôt, et il lui faudra du temps pour réapprendre à habiter pleinement cette vie qu'elle avait quittée avec tant d'appréhension, et qu'elle retrouve aujourd'hui avec un mélange de joie sincère et de trouble inattendu."
          ],
          questions: [
            'Comment se sent-elle en sortant de l’avion ?',
            'Que remarque son amie chez elle ?',
            'Pourquoi se sent-elle « étrangère dans son propre pays » ?'
          ],
          ordering: {
            prompt: 'Remets les moments de ce retour dans l’ordre.',
            events: [
              'L’avion atterrit à Saint-Domingue.',
              'Son amie remarque qu’elle parle différemment.',
              'Elle observe les rues familières depuis la voiture.',
              'Elle repense, le soir, à ce qu’une amie lui avait dit avant son départ.'
            ]
          }
        },
        exercises: [
          { type: 'mcq', prompt: 'Idée principale : de quoi parle ce texte ?', options: ['D’un voyage touristique à Saint-Domingue', 'D’un retour ambivalent dans un pays natal', 'D’une dispute familiale à l’aéroport', 'D’un problème de vol retardé'], answer: 1 },
          { type: 'mcq', prompt: 'Information explicite : qui l’attend à l’aéroport ?', options: ['Seulement ses parents', 'Sa famille et une amie', 'Seulement une amie', 'Des inconnus'], answer: 1 },
          { type: 'mcq', prompt: 'Que remarque son amie chez elle ?', options: ['Qu’elle a beaucoup grossi', 'Qu’elle parle différemment, avec des pauses', 'Qu’elle ne veut plus parler espagnol', 'Qu’elle a changé de nom'], answer: 1 },
          { type: 'mcq', prompt: 'Inférence : pourquoi compare-t-elle inconsciemment les deux villes ?', options: ['Parce qu’elle déteste son pays', 'Parce que son séjour à l’étranger a transformé son regard', 'Parce qu’elle veut convaincre sa famille de déménager', 'Parce que c’est un exercice scolaire'], answer: 1 },
          { type: 'mcq', prompt: 'Intention communicative : que voulait dire son amie avec « revenir chez toi ne sera pas aussi simple » ?', options: ['Qu’il y aurait des problèmes d’avion', 'Qu’un retour implique aussi une forme de réadaptation', 'Que sa famille serait fâchée', 'Qu’elle devrait rester à l’étranger'], answer: 1 },
          { type: 'mcq', prompt: 'Cause et conséquence : pourquoi fait-elle des pauses en parlant espagnol ?', options: ['Elle a oublié sa langue maternelle', 'Elle traduit inconsciemment depuis le français', 'Elle est fatiguée du voyage', 'Elle ne veut pas parler à son amie'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Opinion vs fait : quelle phrase exprime un sentiment, pas un fait ?', options: ['L’avion atterrit à Saint-Domingue.', 'Elle a l’étrange sensation d’être devenue une étrangère dans son propre pays.', 'Son amie l’attend à l’aéroport.', 'Elle était partie un an plus tôt.'], answer: 1 },
          { type: 'mcq', prompt: 'Conclusion : quelle est la conclusion implicite du texte ?', options: ['Elle regrette complètement son séjour à l’étranger', 'Le retour chez soi peut être aussi complexe qu’un départ', 'Il ne faut jamais voyager à l’étranger', 'Elle n’a plus d’amis'], answer: 1 },
          { type: 'mcq', prompt: 'Comparaison d’informations : qu’est-ce qui a changé chez elle, selon le texte, depuis son départ ?', options: ['Rien du tout', 'Sa façon de percevoir son pays et elle-même', 'Son apparence physique uniquement', 'Sa relation avec ses parents seulement'], answer: 1 }
        ]
      }),
      ...
      speaking: activity('speaking', {
        ...
        dialogue: [
          { speaker: 'Modèle', line: 'D’un côté, j’étais heureux/heureuse de retrouver ma famille. De l’autre, j’avais le sentiment étrange d’avoir changé plus que prévu.', translation: 'Por un lado, estaba feliz de reencontrarme con mi familia. Por otro, tenía la extraña sensación de haber cambiado más de lo esperado.' }
        ],
        exercises: [
      ...
      grammar: activity('grammar', {
        ...
        exercises: [
          { type: 'mcq', prompt: 'Elle ___ presque oublié la chaleur de Saint-Domingue.', options: ['a', 'avait', 'ait', 'aura'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Elle n’___ pas anticipé que le retour serait difficile.', options: ['a', 'avait', 'ait', 'aurait'], answer: 1 },
      ...
      dialogue: activity('dialogue', {
        ...
        description: 'Le premier soir du retour, la famille interroge la jeune expatriée sur son année à l’étranger.',
        intro: 'Autour de la table, la famille veut tout savoir sur cette année passée loin de chez elle.',
        dialogue: [
          ...
          { speaker: 'La fille', line: 'C’était incroyable, mais aussi plus difficile que je ne l’avais imaginé au début.', translation: 'Fue increíble, pero también más difícil de lo que había imaginado al principio.' },
          ...
          { speaker: 'La fille', line: 'Oui, je crois que oui, même si ça me fait un peu peur de repartir si loin.', translation: 'Sí, creo que sí, aunque me da un poco de miedo irme tan lejos de nuevo.' }
        ],
        phrases: ['Raconte-nous tout !', 'C’était plus... que je ne l’avais imaginé.', 'Tu comptes... ?', 'Ça me fait un peu peur de...'],
        exercises: [
          { type: 'mcq', prompt: 'Comment la jeune femme décrit-elle son année à l’étranger ?', options: ['Ennuyeuse et facile', 'Incroyable, mais plus difficile que prévu', 'Un échec complet', 'Sans intérêt'], answer: 1 },
          { type: 'mcq', prompt: 'Que demande le père ?', options: ['Si elle a bien mangé', 'Si elle compte retourner à l’étranger pour ses études', 'Si elle a rencontré quelqu’un', 'Si elle veut rester définitivement'], answer: 1 },
          { type: 'mcq', prompt: 'Comment se sent-elle à l’idée de repartir ?', options: ['Complètement confiante', 'Un peu effrayée, mais déterminée', 'Totalement contre l’idée', 'Indifférente'], answer: 1 }
        ]
      })
    }
  },
    ...
    activities: {
      reading: activity('reading', {
        ...
        exercises: [
          ...
          { type: 'mcq', prompt: 'Information explicite : pour quelle formation candidate-t-elle ?', options: ['Une licence de médecine', 'Une licence de langues étrangères appliquées', 'Un master de commerce', 'Un diplôme d’ingénieur'], answer: 1 },
          { type: 'mcq', prompt: 'Quelle structure son ami propose-t-il pour la lettre ?', options: ['Une seule longue phrase', 'Déclencheur, exemples concrets, ce qu’elle apportera', 'Uniquement des compliments sur la France', 'Une liste de ses notes scolaires'], answer: 1 },
          { type: 'mcq', prompt: 'Inférence : pourquoi son ami insiste-t-il sur les exemples concrets ?', options: ['Parce que c’est obligatoire administrativement', 'Parce que des exemples précis rendent l’argumentation plus convaincante', 'Parce qu’il veut que la lettre soit plus longue', 'Parce qu’elle écrit trop vite'], answer: 1 },
          { type: 'mcq', prompt: 'Quel exemple concret mentionne-t-elle dans sa lettre ?', options: ['Un voyage à Paris', 'Avoir aidé une touriste perdue à traduire', 'Un problème de logement', 'Une compétition sportive'], answer: 1 },
          { type: 'mcq', prompt: 'Cause et conséquence : pourquoi veut-elle devenir traductrice ?', options: ['Parce que c’est bien payé', 'Pour aider d’autres personnes à franchir des barrières linguistiques', 'Parce que ses parents l’exigent', 'Par hasard, sans raison précise'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Opinion vs fait : quelle phrase exprime une opinion ?', options: ['Elle candidate à l’université de Tours.', 'Elle a le sentiment d’avoir exprimé honnêtement qui elle est devenue.', 'Son ami a rédigé plusieurs lettres de motivation.', 'Son amie relit sa lettre par appel vidéo.'], answer: 1 },
          { type: 'mcq', prompt: 'Conclusion : comment se sent-elle après avoir envoyé sa candidature ?', options: ['Complètement indifférente', 'Fière du chemin parcouru, quel que soit le résultat', 'Certaine d’être refusée', 'En colère contre l’université'], answer: 1 },
          { type: 'mcq', prompt: 'Intention communicative : pourquoi mentionne-t-elle son exposé sur les cultures dominicaine et française ?', options: ['Pour se plaindre de l’école', 'Pour illustrer concrètement son intérêt pour l’interculturalité', 'Parce que c’est obligatoire dans toute lettre', 'Pour critiquer ses camarades de classe'], answer: 1 }
        ]
      }),
      listening: activity('listening', {
      ...
      dialogue: activity('dialogue', {
        title: 'La relecture entre amies',
        description: 'Une amie aide une candidate à relire et corriger sa lettre de motivation.',
        intro: 'Avant d’envoyer sa candidature, une lycéenne demande à une amie de relire son texte en français.',
        dialogue: [
          { speaker: 'La candidate', line: 'Tu peux relire ma lettre ? J’ai peur qu’il y ait des fautes.', translation: '¿Puedes releer mi carta? Temo que haya errores.' },
          { speaker: 'L’amie', line: 'Bien sûr ! C’est très bien écrit, juste une petite erreur ici.', translation: '¡Claro! Está muy bien escrita, solo un pequeño error aquí.' },
          { speaker: 'La candidate', line: 'Merci, je suis tellement stressée à l’idée de l’envoyer.', translation: 'Gracias, estoy tan estresada con la idea de enviarla.' },
          { speaker: 'L’amie', line: 'Tu as raison d’être fière de ce que tu as écrit, c’est sincère et convaincant.', translation: 'Tienes razón en estar orgullosa de lo que escribiste, es sincero y convincente.' }
        ],
        phrases: ['Tu peux relire... ?', 'J’ai peur qu’il y ait...', 'Je suis stressé(e) à l’idée de...', 'Tu as raison d’être fière de...'],
        exercises: [
          { type: 'mcq', prompt: 'Pourquoi la candidate demande-t-elle à son amie de relire sa lettre ?', options: ['Pour la traduire en anglais', 'Elle a peur qu’il y ait des fautes', 'Son amie doit la réécrire entièrement', 'C’est une obligation administrative'], answer: 1 },
          { type: 'mcq', prompt: 'Comment l’amie trouve-t-elle la lettre ?', options: ['Mauvaise et à refaire', 'Bien écrite, avec une petite erreur', 'Trop courte', 'Incompréhensible'], answer: 1 },
          { type: 'mcq', prompt: 'Comment l’amie qualifie-t-elle la lettre à la fin ?', options: ['Ennuyeuse', 'Sincère et convaincante', 'Trop longue', 'Impersonnelle'], answer: 1 }
        ]
      })
    }
  },
  // ---------------------------------------------------------------
  {
    ...
    activities: {
      reading: activity('reading', {
        ...
        description: 'Une étudiante participe pour la première fois à un débat en ligne sur l’usage des écrans chez les jeunes.',
        reading: {
          title: 'Le club de discussion',
          parts: [
            "Pour continuer à pratiquer son français, une étudiante rejoint un club de discussion en ligne organisé par d'anciens élèves d'échange scolaire, où l'on débat chaque semaine d'un sujet de société différent. Ce soir, le thème est : « Faut-il limiter l'usage des écrans chez les adolescents ? » Un peu nerveuse à l'idée de débattre devant des inconnus, elle écoute d'abord attentivement les arguments des autres participants avant de prendre la parole.",
          ...
          ordering: {
            ...
            events: [
              ...
              'L’étudiante partage son expérience personnelle des réseaux sociaux.',
        ...
        exercises: [
          ...
          { type: 'mcq', prompt: 'Quel argument personnel l’étudiante apporte-t-elle ?', options: ['Les réseaux sociaux ne servent à rien', 'Ils l’ont aidée à garder contact, mais peuvent créer du stress', 'Elle n’a jamais utilisé de réseaux sociaux', 'Elle est complètement contre les écrans'], answer: 1 },
          { type: 'mcq', prompt: 'Inférence : pourquoi son intervention est-elle bien accueillie ?', options: ['Parce qu’elle a parlé le plus fort', 'Parce qu’elle apporte une perspective fondée sur une expérience vécue', 'Parce qu’elle a flatté les autres participants', 'Parce qu’elle a terminé le débat rapidement'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Opinion vs fait : quelle phrase exprime un fait, et non une opinion ?', options: ['Il me semble que les écrans peuvent être un outil éducatif.', 'L’étudiante rejoint un club de discussion en ligne chaque semaine.', 'Je pense que le vrai problème est le contenu.', 'Ils ne peuvent donc pas être considérés uniquement comme négatifs.'], answer: 1 },
          { type: 'mcq', prompt: 'Conclusion : comment se sent l’étudiante à la fin du débat ?', options: ['Déçue de sa performance', 'Satisfaite d’avoir argumenté en français sur un sujet complexe', 'Fâchée contre les autres participants', 'Indifférente'], answer: 1 },
      ...
      dialogue: activity('dialogue', {
        ...
        description: 'Deux amis discutent de leur expérience au club de discussion.',
        intro: 'Après la session, une participante appelle un ami pour lui raconter son premier débat en français.',
        dialogue: [
          { speaker: 'La participante', line: 'J’ai réussi à débattre en français devant des inconnus, tu te rends compte ?', translation: 'Logré debatir en francés frente a desconocidos, ¿te das cuenta?' },
          { speaker: 'L’ami', line: 'C’est génial, je suis vraiment fier de toi !', translation: '¡Es genial, estoy muy orgulloso de ti!' },
          { speaker: 'La participante', line: 'J’étais nerveuse au début, mais j’ai fini par prendre confiance.', translation: 'Estaba nerviosa al principio, pero terminé ganando confianza.' },
          { speaker: 'L’ami', line: 'C’est exactement comme ça qu’on progresse vraiment dans une langue.', translation: 'Así es exactamente como se progresa de verdad en un idioma.' }
        ],
        phrases: ['Tu te rends compte ?', 'Je suis fier/fière de toi.', 'J’ai fini par...', 'C’est comme ça qu’on progresse.'],
        exercises: [
          { type: 'mcq', prompt: 'Qu’a réussi à faire la participante pour la première fois ?', options: ['Écrire un livre', 'Débattre en français devant des inconnus', 'Voyager seule', 'Passer un examen officiel'], answer: 1 },
          { type: 'mcq', prompt: 'Comment se sentait-elle au début du débat ?', options: ['Très confiante', 'Nerveuse', 'Indifférente', 'En colère'], answer: 1 },
          { type: 'mcq', prompt: 'Que pense l’ami de ce type d’exercice pour apprendre une langue ?', options: ['Que ce n’est pas utile', 'Que c’est exactement comme ça qu’on progresse', 'Qu’il vaut mieux éviter les débats', 'Qu’il faut seulement étudier la grammaire'], answer: 1 }
        ]
      })
    }
  },
  // ---------------------------------------------------------------
  {
    ...
    activities: {
      reading: activity('reading', {
        ...
        description: 'Une jeune traductrice commence un emploi de traduction à distance et découvre les avantages et les difficultés du télétravail.',
        reading: {
          title: 'Travailler seule chez soi',
          parts: [
            "En attendant la réponse de l'université de Tours, une jeune femme décide de mettre à profit ses compétences linguistiques en acceptant un petit contrat de traduction à distance pour une agence spécialisée dans les documents touristiques. Chaque matin, elle s'installe à son bureau, allume son ordinateur, et commence à traduire des brochures de l'espagnol vers le français, tout en écoutant parfois de la musique douce pour rester concentrée. « C'est étrange de travailler sans jamais rencontrer physiquement mes collègues », confie-t-elle à un ami lors d'un appel vidéo. « Mais en même temps, ça me permet d'organiser ma journée exactement comme je le souhaite. »",
            "Après quelques semaines, elle commence néanmoins à ressentir certaines limites de ce mode de travail. En travaillant seule chez elle toute la journée, elle réalise à quel point les interactions sociales spontanées lui manquent : les petites conversations informelles, les pauses café partagées, les blagues échangées entre collègues. Ce dont elle a le plus besoin, remarque-t-elle, ce n'est pas tant de superviseur ou d'horaires fixes, mais simplement de présence humaine régulière. Sa mère, en la voyant travailler d'affilée pendant des heures sans sortir de sa chambre, s'inquiète également : « Tu devrais peut-être aller travailler dans un café de temps en temps, pour changer d'air. »",
            "Elle décide alors de suivre ce conseil et commence à travailler deux après-midis par semaine dans un café près de chez elle. Ce changement, aussi simple soit-il, améliore considérablement son moral : elle apprécie l'ambiance animée du lieu, tout en restant suffisamment concentrée pour respecter ses délais de traduction. Elle comprend alors que le télétravail, contrairement à ce qu'elle avait imaginé au début, n'est ni entièrement positif ni entièrement négatif : tout dépend de la façon dont on organise son environnement et ses relations sociales autour de ce nouveau rythme de vie.",
            "Ce petit emploi lui permet également de mettre en pratique, de façon très concrète, les compétences qu'elle espère développer davantage à l'université : la précision linguistique, la rigueur, et la capacité à s'adapter à des contextes professionnels variés. Elle prend conscience, en discutant avec une amie un soir, que cette expérience, bien que modeste, constitue déjà une première étape vers le métier de traductrice dont elle rêve depuis son année en France. « Je crois que je suis vraiment sur la bonne voie », confie-t-elle à son amie, avec une confiance qu'elle n'aurait pas eue un an plus tôt."
          ],
          questions: [
            'Pourquoi accepte-t-elle ce contrat de traduction à distance ?',
            'Quelle limite du télétravail découvre-t-elle après quelques semaines ?',
            'Quelle solution trouve-t-elle pour améliorer son moral ?'
          ],
          ordering: {
            prompt: 'Remets les étapes de cette expérience dans l’ordre.',
            events: [
              'Elle accepte un contrat de traduction à distance.',
              'Elle réalise que les interactions sociales lui manquent.',
              'Sa mère lui suggère de travailler parfois dans un café.',
              'Elle comprend que le télétravail dépend de son organisation personnelle.'
            ]
          }
        },
        exercises: [
          { type: 'mcq', prompt: 'Idée principale : de quoi parle ce texte ?', options: ['D’un voyage professionnel', 'D’une expérience de télétravail', 'D’un conflit avec un employeur', 'D’une candidature refusée'], answer: 1 },
          { type: 'mcq', prompt: 'Information explicite : quel type de traduction fait-elle ?', options: ['Des documents juridiques', 'Des brochures touristiques', 'Des livres scientifiques', 'Des articles de presse'], answer: 1 },
          { type: 'mcq', prompt: 'Quel avantage du télétravail mentionne-t-elle au début ?', options: ['Un meilleur salaire', 'La liberté d’organiser sa journée', 'Moins de travail à faire', 'Plus de vacances'], answer: 1 },
          { type: 'mcq', prompt: 'Quelle limite ressent-elle après quelques semaines ?', options: ['Le manque d’équipement', 'Le manque d’interactions sociales', 'Le manque d’argent', 'Le manque de temps libre'], answer: 1 },
          { type: 'mcq', prompt: 'Que suggère sa mère ?', options: ['D’arrêter de travailler', 'D’aller travailler parfois dans un café', 'De changer complètement de métier', 'De déménager'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Opinion vs fait : quelle phrase exprime une conclusion personnelle ?', options: ['Elle traduit des brochures touristiques.', 'Le télétravail n’est ni entièrement positif ni entièrement négatif.', 'Elle travaille deux après-midis au café.', 'Sa mère s’inquiète en la voyant travailler.'], answer: 1 },
          { type: 'mcq', prompt: 'Inférence : que représente ce petit emploi pour son avenir ?', options: ['Une perte de temps', 'Une première étape vers le métier de traductrice', 'Un obstacle à ses études', 'Une expérience sans importance'], answer: 1 },
          { type: 'mcq', prompt: 'Conclusion : comment se sent-elle à la fin du texte, comparée à un an plus tôt ?', options: ['Moins confiante', 'Plus confiante dans son projet professionnel', 'Exactement pareille', 'Découragée'], answer: 1 }
        ]
      }),
      listening: activity('listening', {
      ...
      dialogue: activity('dialogue', {
        ...
        description: 'Une jeune traductrice travaille pour la première fois dans un café et raconte son expérience à une amie.',
        intro: 'Après plusieurs semaines de travail isolé, une jeune femme essaie de travailler dans un café pour la première fois.',
        dialogue: [
          { speaker: 'L’amie', line: 'Alors, comment c’était, travailler au café aujourd’hui ?', translation: '¿Y cómo estuvo trabajar en el café hoy?' },
          { speaker: 'La traductrice', line: 'Vraiment agréable ! L’ambiance m’a aidée à rester motivée toute la journée.', translation: '¡Realmente agradable! El ambiente me ayudó a mantenerme motivada todo el día.' },
          { speaker: 'L’amie', line: 'Tu vas continuer à y aller régulièrement ?', translation: '¿Vas a seguir yendo regularmente?' },
          { speaker: 'La traductrice', line: 'Oui, je pense que ça va devenir une bonne habitude pour moi.', translation: 'Sí, creo que se va a convertir en un buen hábito para mí.' }
        ],
        phrases: ['Comment c’était... ?', 'L’ambiance m’a aidée à...', 'Tu vas continuer à... ?', 'Ça va devenir une bonne habitude.'],
        exercises: [
          { type: 'mcq', prompt: 'Comment décrit-elle sa journée au café ?', options: ['Ennuyeuse', 'Agréable et motivante', 'Fatigante', 'Décevante'], answer: 1 },
          { type: 'mcq', prompt: 'Que demande son amie à la fin ?', options: ['Si elle va arrêter de travailler', 'Si elle va continuer à aller au café', 'Si elle veut changer de métier', 'Si elle est fatiguée'], answer: 1 },
          { type: 'mcq', prompt: 'Que pense-t-elle de cette nouvelle habitude ?', options: ['Elle ne va pas la garder', 'Elle pense que ça va devenir une bonne habitude', 'Elle est indifférente', 'Elle préfère travailler seule'], answer: 1 }
        ]
      })
    }
  },
  // ---------------------------------------------------------------
  {
    ...
    activities: {
      reading: activity('reading', {
        ...
        reading: {
          ...
          questions: [
            ...
            'Comment la lectrice interprète-t-elle personnellement le roman ?'
          ],
          ordering: {
            prompt: 'Remets les moments de la réunion du club de lecture dans l’ordre.',
            events: [
              'Elle commence à lire le roman et se reconnaît dans le personnage.',
              'L’animatrice explique le thème du déracinement et de l’identité.',
              'Elle partage son interprétation personnelle du roman.',
              'Elle décide de commander le roman suivant proposé par le club.'
            ]
          }
        },
        exercises: [
          { type: 'mcq', prompt: 'Idée principale : de quoi parle ce texte ?', options: ['D’un cours de grammaire française', 'De la découverte de la littérature francophone par une lectrice', 'D’un voyage en Guadeloupe', 'D’un problème technique lors d’une visioconférence'], answer: 1 },
          { type: 'mcq', prompt: 'Information explicite : qui a écrit le roman étudié ?', options: ['Un auteur français', 'Une autrice guadeloupéenne', 'Un auteur dominicain', 'La lectrice elle-même'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Comment la lectrice interprète-t-elle son propre sentiment « entre deux mondes » après cette lecture ?', options: ['Comme un problème à résoudre absolument', 'Comme une nouvelle façon d’exister', 'Comme une erreur de jeunesse', 'Comme quelque chose à cacher'], answer: 1 },
          { type: 'mcq', prompt: 'Inférence : pourquoi les autres participants sont-ils touchés par son intervention ?', options: ['Parce qu’elle a parlé très fort', 'Parce que son interprétation personnelle résonne avec le texte', 'Parce qu’elle a critiqué le roman', 'Parce qu’elle a fait une erreur de français'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Opinion vs fait : quelle phrase exprime un fait, et non une impression ?', options: ['Elle se reconnaît dans le personnage principal.', 'L’animatrice est une professeure de littérature à la retraite.', 'Ce roman lui a fait comprendre beaucoup de choses.', 'Elle ressent un sentiment inhabituel de plénitude.'], answer: 1 },
          { type: 'mcq', prompt: 'Conclusion : que représente désormais le français pour elle, selon la fin du texte ?', options: ['Un outil purement pratique, rien de plus', 'Une langue dans laquelle elle pense et se comprend elle-même', 'Une langue qu’elle veut abandonner', 'Une matière scolaire obligatoire'], answer: 1 },
          { type: 'mcq', prompt: 'Intention communicative : pourquoi décide-t-elle de commander le roman suivant ?', options: ['Par obligation pour le club', 'Parce qu’elle est impatiente de continuer cette exploration littéraire', 'Parce que c’est gratuit', 'Parce qu’une amie le lui a demandé'], answer: 1 }
        ]
      }),
      listening: activity('listening', {
      ...
      dialogue: activity('dialogue', {
        ...
        description: 'Une lectrice raconte à une amie sa nouvelle passion pour la littérature francophone.',
        intro: 'Après la réunion du club de lecture, une jeune femme partage son enthousiasme avec une amie.',
        dialogue: [
          { speaker: 'L’amie', line: 'Tu as l’air vraiment enthousiaste par ce club de lecture !', translation: '¡Pareces realmente entusiasmada con ese club de lectura!' },
          { speaker: 'La lectrice', line: 'Oui, ce roman m’a fait comprendre beaucoup de choses sur moi-même.', translation: 'Sí, esta novela me hizo entender muchas cosas sobre mí misma.' },
          { speaker: 'L’amie', line: 'Tu pourrais me le prêter en espagnol, s’il existe une traduction ?', translation: '¿Me lo podrías prestar en español, si existe una traducción?' },
          { speaker: 'La lectrice', line: 'Bien sûr ! Je pense que tu aimerais beaucoup ce livre.', translation: '¡Claro! Creo que te gustaría mucho este libro.' }
        ],
        phrases: ['Tu as l’air...', 'Ça m’a fait comprendre...', 'Tu pourrais me... ?', 'Je pense que tu aimerais...'],
        exercises: [
          { type: 'mcq', prompt: 'Comment l’amie perçoit-elle cet enthousiasme ?', options: ['Elle ne le remarque pas', 'Elle le remarque et le mentionne', 'Elle s’en moque', 'Elle est jalouse'], answer: 1 },
          { type: 'mcq', prompt: 'Que demande l’amie ?', options: ['De ne plus parler du livre', 'De lui prêter le livre en espagnol', 'D’arrêter le club de lecture', 'De lui offrir le livre'], answer: 1 },
          { type: 'mcq', prompt: 'Comment la lectrice répond-elle à cette demande ?', options: ['Elle refuse', 'Elle accepte avec plaisir', 'Elle ne répond pas', 'Elle change de sujet'], answer: 1 }
        ]
      })
    }
  },
  // ---------------------------------------------------------------
  {
    ...
    activities: {
      reading: activity('reading', {
        ...
        description: 'Une spectatrice regarde un film français et rédige, pour son blog, sa première vraie critique de cinéma.',
        reading: {
          title: 'Ma première critique de cinéma',
          parts: [
            "Une jeune spectatrice passe son samedi soir à regarder un film français récent, recommandé par une amie lors d'un appel vidéo la semaine précédente. Il s'agit d'un drame familial se déroulant dans une petite ville de province, racontant l'histoire de trois sœurs qui se retrouvent après des années de silence pour régler la succession de leur mère. Dès les premières minutes, elle est frappée par la qualité de la mise en scène : les silences, les regards échangés entre les personnages, tout semble raconter une histoire aussi importante que les dialogues eux-mêmes.",
            "Après le film, elle décide de rédiger sa première vraie critique de cinéma pour le blog qu'elle a commencé à tenir. « Ce qui m'a le plus marquée dans ce film, c'est la façon dont la réalisatrice parvient à créer une tension palpable sans jamais recourir à des effets spectaculaires », écrit-elle. « Ce que j'ai particulièrement apprécié, c'est le jeu des trois actrices principales, absolument convaincantes dans leur complexité émotionnelle. »",
            "Cependant, elle reste honnête dans son évaluation : elle reconnaît que le rythme du film, particulièrement lent pendant la première demi-heure, pourrait rebuter certains spectateurs habitués à des scénarios plus rythmés. « Ce n'est certainement pas le film le plus divertissant que j'aie vu cette année, mais c'est probablement l'un des plus émouvants et des mieux interprétés », conclut-elle. Elle ajoute également une remarque sur la fin du film, sans trop en révéler pour ne pas gâcher la surprise à ses lecteurs : le dernier rebondissement lui a semblé un peu prévisible, mais n'a en rien diminué l'impact émotionnel de l'ensemble.",
            "En relisant sa critique avant de la publier, elle réalise avec fierté à quel point elle a progressé en français : non seulement elle comprend désormais des films entiers sans sous-titres, mais elle est également capable d'analyser leur construction narrative et d'exprimer une opinion nuancée et argumentée à leur sujet. Une amie, en lisant le texte par-dessus son épaule, s'exclame : « Tu écris exactement comme une vraie critique de cinéma ! » Elle sourit, fière de ce nouveau talent qu'elle ne se connaissait pas."
          ],
          questions: [
            'De quel type de film s’agit-il ?',
            'Qu’est-ce que la spectatrice a le plus apprécié dans ce film ?',
            'Quelle réserve exprime-t-elle dans sa critique ?'
          ],
          ordering: {
            prompt: 'Remets les étapes de cette soirée dans l’ordre.',
            events: [
              'Elle regarde le film recommandé par une amie.',
              'Elle commence à rédiger sa critique pour son blog.',
        ...
        exercises: [
          { type: 'mcq', prompt: 'Idée principale : de quoi parle ce texte ?', options: ['D’un cours de cinéma à l’université', 'De la rédaction d’une critique de film', 'D’un tournage de film en France', 'D’une dispute entre deux amies'], answer: 1 },
          { type: 'mcq', prompt: 'Information explicite : quel type de film regarde-t-elle ?', options: ['Une comédie romantique', 'Un drame familial', 'Un film d’action', 'Un documentaire animalier'], answer: 1 },
          { type: 'mcq', prompt: 'Qu’est-ce qu’elle apprécie particulièrement dans le film ?', options: ['Les effets spéciaux', 'Le jeu des trois actrices principales', 'La musique', 'Les décors'], answer: 1 },
          { type: 'mcq', prompt: 'Quelle réserve exprime-t-elle sur le film ?', options: ['Les acteurs sont mauvais', 'Le rythme est lent pendant la première demi-heure', 'L’histoire n’a aucun sens', 'Le film est trop court'], answer: 1 },
          { type: 'mcq', prompt: 'Que pense-t-elle du dernier rebondissement du film ?', options: ['Il est totalement surprenant', 'Il lui a semblé un peu prévisible', 'Il n’existe pas', 'Elle ne le comprend pas'], answer: 1 },
          { type: 'mcq', prompt: 'Cause et conséquence : pourquoi reste-t-elle honnête dans sa critique malgré son appréciation du film ?', options: ['Parce qu’elle n’aime pas vraiment le film', 'Parce qu’une critique nuancée est plus juste et crédible', 'Parce qu’une amie le lui a demandé', 'Par obligation du blog'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Conclusion : que réalise-t-elle en relisant sa critique ?', options: ['Qu’elle n’a rien appris', 'À quel point elle a progressé en français', 'Qu’elle déteste le cinéma', 'Qu’elle veut arrêter son blog'], answer: 1 },
          { type: 'mcq', prompt: 'Intention communicative : pourquoi ne révèle-t-elle pas trop la fin du film ?', options: ['Parce qu’elle l’a oubliée', 'Pour ne pas gâcher la surprise à ses lecteurs', 'Parce que c’est interdit', 'Parce que la fin n’a pas d’importance'], answer: 1 }
        ]
      }),
      listening: activity('listening', {
      ...
      dialogue: activity('dialogue', {
        ...
        description: 'Une blogueuse hésite à publier sa critique et demande l’avis d’une amie.',
        intro: 'Avant de publier son article, une jeune critique demande une dernière relecture à une amie.',
        dialogue: [
          { speaker: 'La blogueuse', line: 'Tu penses que je devrais publier cette critique telle quelle ?', translation: '¿Crees que debería publicar esta crítica tal cual?' },
          { speaker: 'L’amie', line: 'Oui, complètement ! Elle est honnête et bien argumentée.', translation: '¡Sí, completamente! Es honesta y está bien argumentada.' },
          { speaker: 'La blogueuse', line: 'J’ai un peu peur que les gens ne soient pas d’accord avec moi.', translation: 'Tengo un poco de miedo de que la gente no esté de acuerdo conmigo.' },
          { speaker: 'L’amie', line: 'C’est justement ça, une bonne critique : donner un avis personnel assumé.', translation: 'Precisamente eso es una buena crítica: dar una opinión personal asumida.' }
        ],
        phrases: ['Tu penses que je devrais... ?', 'Elle est honnête et bien argumentée.', 'J’ai peur que...', 'Un avis personnel assumé.'],
        exercises: [
          { type: 'mcq', prompt: 'Que demande la blogueuse à son amie ?', options: ['De réécrire toute la critique', 'Son avis sur la publication de la critique', 'De la traduire en espagnol', 'De supprimer l’article'], answer: 1 },
          { type: 'mcq', prompt: 'Comment l’amie trouve-t-elle la critique ?', options: ['Trop courte', 'Honnête et bien argumentée', 'Incompréhensible', 'Trop négative'], answer: 1 },
          { type: 'mcq', prompt: 'Quelle est la peur de la blogueuse ?', options: ['D’être en retard', 'Que les gens ne soient pas d’accord avec elle', 'De perdre son ordinateur', 'De ne plus aimer le cinéma'], answer: 1 }
        ]
      })
    }
  },
  // ---------------------------------------------------------------
  {
    ...
    activities: {
      reading: activity('reading', {
        ...
        description: 'Des étudiants participent à un débat philosophique en ligne autour d’un dilemme moral classique.',
        reading: {
          title: 'Le dilemme du forum',
          parts: [
            "Dans le cadre d'un cours de philosophie en ligne, des étudiants doivent participer à un forum de discussion consacré à un dilemme moral classique : que ferait-on si l'on découvrait qu'un ami proche avait menti pour obtenir un avantage injuste, sans que personne d'autre ne le sache ? Faut-il le dénoncer, au risque de briser une amitié précieuse, ou rester silencieux, au risque de cautionner une injustice ? Le sujet, en apparence simple, suscite des dizaines de réponses passionnées de la part des participants.",
            "Un participant argentin écrit : « Si j'avais découvert un tel mensonge, j'aurais probablement confronté directement mon ami, sans passer par une dénonciation publique. » Une autre étudiante, sénégalaise, nuance : « Tout dépend des conséquences du mensonge. Si personne n'avait été lésé par cette action, j'aurais peut-être choisi de ne rien dire, tout en exprimant clairement ma désapprobation à mon ami. » Une troisième participante, en lisant ces différents points de vue, réalise à quel point ce type de dilemme ne possède aucune réponse universelle et définitive.",
          ...
          ordering: {
            ...
            events: [
              ...
              'Une troisième participante partage sa propre position et repense à une expérience similaire.'
            ]
          }
        },
        exercises: [
          ...
          { type: 'mcq', prompt: 'Quelle est la position finale de la troisième participante ?', options: ['Elle condamne fermement le silence', 'Elle aurait du mal à se taire, mais comprend aussi le choix du silence', 'Elle refuse de donner un avis', 'Elle pense qu’il faut toujours dénoncer'], answer: 1 },
          { type: 'mcq', prompt: 'Inférence : pourquoi le professeur salue-t-il cette intervention ?', options: ['Parce qu’elle a écrit le plus long message', 'Parce qu’elle formule une position claire tout en reconnaissant d’autres perspectives', 'Parce qu’elle a flatté le professeur', 'Parce qu’elle a copié un autre message'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Opinion vs fait : quelle phrase exprime une opinion personnelle ?', options: ['Des étudiants s’inscrivent à un cours de philosophie en ligne.', 'Juger rapidement la situation de quelqu’un me semble toujours risqué.', 'Un participant argentin a répondu au forum.', 'Le sujet suscite des dizaines de réponses.'], answer: 1 },
          { type: 'mcq', prompt: 'À quelle expérience personnelle la participante repense-t-elle ?', options: ['Un examen raté', 'Une tricherie qu’elle avait hésité à signaler', 'Un voyage en Argentine', 'Une dispute avec une amie'], answer: 1 },
      ...
      dialogue: activity('dialogue', {
        ...
        description: 'Une étudiante raconte à un ami une situation similaire qu’elle a vécue.',
        intro: 'Une participante appelle un ami pour lui raconter le dilemme du forum et un souvenir personnel.',
        dialogue: [
          { speaker: 'L’étudiante', line: 'Tu te souviens de la tricherie pendant l’examen, l’année dernière ?', translation: '¿Te acuerdas de la trampa durante el examen, el año pasado?' },
          { speaker: 'L’ami', line: 'Oui, tu avais hésité longtemps avant de la signaler.', translation: 'Sí, habías dudado mucho antes de reportarla.' },
          { speaker: 'L’étudiante', line: 'Exactement. Si j’avais su à quel point ce serait difficile, j’aurais peut-être réagi différemment.', translation: 'Exactamente. Si hubiera sabido lo difícil que sería, quizás habría reaccionado diferente.' },
          { speaker: 'L’ami', line: 'Je pense que tu as fait le bon choix, malgré tout.', translation: 'Creo que tomaste la decisión correcta, a pesar de todo.' }
        ],
        phrases: ['Tu te souviens de... ?', 'Tu avais hésité...', 'Si j’avais su..., j’aurais...', 'Tu as fait le bon choix.'],
        exercises: [
          { type: 'mcq', prompt: 'À quel souvenir l’étudiante fait-elle référence ?', options: ['Un voyage raté', 'Une tricherie pendant un examen', 'Une dispute avec une amie', 'Un accident de vélo'], answer: 1 },
          { type: 'mcq', prompt: 'Que dit-elle sur sa réaction à l’époque ?', options: ['Elle avait réagi immédiatement', 'Elle avait hésité longtemps', 'Elle n’avait rien fait du tout', 'Elle avait menti elle-même'], answer: 1 },
          { type: 'mcq', prompt: 'Que pense l’ami de sa décision ?', options: ['Qu’elle a mal agi', 'Qu’elle a fait le bon choix', 'Qu’il ne sait pas', 'Qu’elle aurait dû ne rien dire'], answer: 1 }
        ]
      })
    }
  },
  // ---------------------------------------------------------------
  {
    ...
    activities: {
      reading: activity('reading', {
        title: 'L’article sur l’intelligence artificielle',
        description: 'Deux amis partagent et discutent un article de vulgarisation scientifique sur l’intelligence artificielle.',
        reading: {
          title: 'L’article sur l’intelligence artificielle',
          parts: [
            "Un étudiant, qui envisage désormais des études d'informatique, envoie un jour à une amie un long article de vulgarisation scientifique sur l'intelligence artificielle, accompagné d'un message enthousiaste : « Il faut absolument que tu lises ça, c'est fascinant ! » L'article explique, en termes accessibles, comment fonctionnent les algorithmes d'apprentissage automatique, ces systèmes capables d’« apprendre » à partir d'énormes quantités de données, sans qu'un humain ne leur explique explicitement chaque règle à suivre.",
            "Elle, intriguée mais aussi un peu inquiète, lit attentivement l'article et découvre que ces technologies sont déjà utilisées dans des domaines aussi variés que la médecine, la traduction automatique, ou même la création artistique. Étant donné que ces systèmes continuent de s'améliorer rapidement, l'article soulève une question qui préoccupe de nombreux chercheurs : quelles seront les répercussions de cette évolution sur le marché du travail dans les prochaines décennies ? Il se peut que certains métiers disparaissent complètement, tandis que d'autres, encore inimaginables aujourd'hui, verront le jour.",
            "En discutant de l'article par appel vidéo, l'étudiant se montre optimiste : « Dans la mesure où l'intelligence artificielle reste un outil créé et contrôlé par des humains, je pense qu'elle peut nous aider à résoudre des problèmes complexes, comme certaines maladies ou le changement climatique. » Son amie, elle, reste plus prudente : « Il est possible que tu aies raison, mais je pense aussi qu'il faut rester vigilant. Une technologie aussi puissante peut être utilisée pour le meilleur comme pour le pire, selon les intentions de ceux qui la contrôlent. »",
            "Cette conversation pousse la jeune femme à réfléchir différemment à son propre projet professionnel : et si son futur métier de traductrice était, lui aussi, transformé par ces nouvelles technologies dans les années à venir ? Plutôt que de s'en inquiéter excessivement, elle décide d'adopter une attitude proactive : elle pourrait, par exemple, se spécialiser dans des domaines de traduction où la sensibilité culturelle et l'interprétation nuancée resteront difficilement remplaçables par une machine, quelle que soit la sophistication de ses algorithmes. Cette perspective la rassure, tout en confirmant l'importance de rester curieuse et informée face à un monde en perpétuelle évolution technologique."
          ],
          questions: [
            'De quel sujet l’article partagé traite-t-il ?',
            'Quelle question l’article soulève-t-il sur le marché du travail ?',
            'Comment la jeune femme réagit-elle finalement à cette réflexion sur son propre avenir professionnel ?'
          ],
          ordering: {
            prompt: 'Remets les étapes de la conversation dans l’ordre.',
            events: [
              'Un étudiant envoie un article sur l’intelligence artificielle à une amie.',
              'Elle lit l’article et découvre ses domaines d’application.',
              'Les deux amis débattent des risques et bénéfices par appel vidéo.',
              'Elle réfléchit à l’impact de ces technologies sur son propre projet professionnel.'
            ]
          }
        },
        exercises: [
          { type: 'mcq', prompt: 'Idée principale : de quoi parle ce texte ?', options: ['D’un voyage scientifique', 'De la découverte de l’intelligence artificielle par une étudiante', 'D’un examen de mathématiques', 'D’un problème informatique'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Quelle est la position de l’étudiant sur l’intelligence artificielle ?', options: ['Complètement négative', 'Optimiste, tant qu’elle reste contrôlée par des humains', 'Indifférente', 'Il refuse d’en parler'], answer: 1 },
          { type: 'mcq', prompt: 'Quelle est la position de son amie ?', options: ['Totalement optimiste', 'Prudente, reconnaissant les deux côtés possibles', 'Complètement négative', 'Elle n’a pas d’opinion'], answer: 1 },
          { type: 'mcq', prompt: 'Cause et conséquence : pourquoi décide-t-elle de se spécialiser dans certains domaines de traduction ?', options: ['Par hasard', 'Pour rester dans des domaines difficiles à remplacer par une machine', 'Parce qu’on le lui a ordonné', 'Parce que c’est plus facile'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Opinion vs fait : quelle phrase exprime une opinion ?', options: ['Un étudiant envoie un article à une amie.', 'Une technologie aussi puissante peut être utilisée pour le meilleur comme pour le pire.', 'L’article explique le fonctionnement des algorithmes.', 'Elle lit attentivement l’article.'], answer: 1 },
          { type: 'mcq', prompt: 'Inférence : quelle attitude adopte-t-elle finalement face à l’IA ?', options: ['Le déni complet', 'Une attitude proactive et curieuse', 'La peur paralysante', 'L’indifférence totale'], answer: 1 },
      ...
      dialogue: activity('dialogue', {
        ...
        description: 'Une étudiante explique à un ami comment cette conversation a influencé son projet professionnel.',
        intro: 'Quelques jours plus tard, une jeune femme rappelle un ami pour lui parler de sa réflexion.',
        dialogue: [
          { speaker: 'L’étudiante', line: 'Notre conversation sur l’IA m’a vraiment fait réfléchir à mon métier futur.', translation: 'Nuestra conversación sobre la IA realmente me hizo reflexionar sobre mi futura profesión.' },
          { speaker: 'L’ami', line: 'Ah oui ? Dans quel sens ?', translation: '¿Ah sí? ¿En qué sentido?' },
          { speaker: 'L’étudiante', line: 'Je pense me spécialiser dans une traduction où la sensibilité culturelle compte énormément.', translation: 'Pienso especializarme en una traducción donde la sensibilidad cultural cuenta muchísimo.' },
          { speaker: 'L’ami', line: 'C’est une excellente idée, ça, une machine ne pourra jamais vraiment le remplacer.', translation: 'Es una excelente idea, eso una máquina nunca podrá reemplazarlo realmente.' }
        ],
        phrases: ['Ça m’a fait réfléchir à...', 'Dans quel sens ?', 'Je pense me spécialiser dans...', 'Une machine ne pourra jamais...'],
        exercises: [
          { type: 'mcq', prompt: 'Comment la conversation sur l’IA l’a-t-elle influencée ?', options: ['Elle a abandonné son projet de traduction', 'Elle a décidé de se spécialiser dans un domaine résistant à l’automatisation', 'Elle veut maintenant étudier l’informatique', 'Elle n’a rien changé du tout'], answer: 1 },
          { type: 'mcq', prompt: 'Que pense l’ami de cette nouvelle idée ?', options: ['Qu’elle est mauvaise', 'Que c’est une excellente idée', 'Il n’a pas d’opinion', 'Qu’elle devrait changer complètement de métier'], answer: 1 },
          { type: 'mcq', prompt: 'Pourquoi pense-t-il qu’une machine ne pourra pas remplacer ce domaine ?', options: ['Parce que c’est trop cher', 'Parce que la sensibilité culturelle est difficile à automatiser', 'Parce que les machines n’existent pas encore', 'Parce que c’est illégal'], answer: 1 }
        ]
      })
    }
  },
  // ---------------------------------------------------------------
  {
    ...
    activities: {
      reading: activity('reading', {
        ...
        description: 'Une petite-fille regarde un documentaire historique avec sa grand-mère, qui partage ses propres souvenirs familiaux.',
        reading: {
          title: 'Le documentaire avec grand-mère',
          parts: [
            "Un dimanche après-midi, une jeune femme regarde avec sa grand-mère un documentaire consacré à l'histoire partagée, complexe et parfois douloureuse, entre Haïti et la République dominicaine, deux pays qui se partagent la même île des Caraïbes. Le documentaire, réalisé par un historien francophone, explore différentes perspectives sur cette histoire commune, en donnant la parole à des chercheurs des deux côtés de la frontière. « C'est fascinant, mais aussi assez difficile à regarder », confie-t-elle à sa grand-mère, en pensant à certains épisodes évoqués dans le film.",
            "Sa grand-mère, qui a vécu une partie de cette histoire à travers les récits que lui racontait sa propre mère, ajoute une dimension personnelle à ce que raconte le documentaire. « Celle dont je me souviens le mieux, c'est l'histoire de ton arrière-arrière-grand-mère, qui avait accueilli chez elle des voisins haïtiens pendant une période particulièrement troublée », raconte-t-elle. « Ce sont des histoires que l'on a longtemps préféré taire dans la famille, mais je pense qu'il est important que tu les connaisses aujourd'hui, pour comprendre d'où tu viens vraiment. »",
            "Profondément touchée par ce témoignage, la jeune femme réalise à quel point la mémoire collective d'un pays est souvent constituée de multiples récits individuels, parfois contradictoires, que l'histoire officielle ne raconte que partiellement. Elle repense également à la diversité culturelle qu'elle a découverte pendant un séjour à l'étranger, où elle avait déjà commencé à réfléchir à la façon dont chaque pays construit sa propre version des événements historiques, en fonction de la perspective de celui qui les raconte.",
            "En fin de soirée, elle remercie sa grand-mère pour ce moment de partage inattendu. « J'aimerais beaucoup que tu me racontes davantage ces histoires familiales, celles que je n'ai jamais entendues », lui dit-elle avec sincérité. Sa grand-mère sourit, visiblement émue par cet intérêt, et promet de continuer ces récits lors de leurs prochains dimanches ensemble. Elle comprend alors que la transmission de la mémoire, loin d'être un simple exercice académique, constitue aussi un acte profondément intime entre les générations, un fil invisible qui relie le passé de sa famille à ce qu'elle est en train de devenir."
          ],
          questions: [
            'Quel est le sujet principal du documentaire regardé en famille ?',
            'Quelle histoire personnelle la grand-mère raconte-t-elle ?',
            'Quelle réflexion la petite-fille tire-t-elle sur la mémoire collective ?'
          ],
          ordering: {
            prompt: 'Remets les moments de l’après-midi dans l’ordre.',
            events: [
              'Elle et sa grand-mère commencent à regarder le documentaire.',
              'La grand-mère raconte l’histoire de l’arrière-arrière-grand-mère.',
              'La jeune femme réfléchit à la nature multiple de la mémoire collective.',
              'Elle demande à sa grand-mère de lui raconter davantage d’histoires familiales.'
            ]
          }
        },
        exercises: [
          ...
          { type: 'mcq', prompt: 'Information explicite : qui a réalisé le documentaire ?', options: ['La grand-mère', 'Un historien francophone', 'La petite-fille elle-même', 'Un journaliste dominicain'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Inférence : pourquoi ce témoignage touche-t-il particulièrement la petite-fille ?', options: ['Parce qu’elle ne connaît pas sa grand-mère', 'Parce qu’il révèle une partie inconnue de son histoire familiale', 'Parce qu’il est raconté en français', 'Parce que c’est amusant'], answer: 1 },
          { type: 'mcq', prompt: 'Quelle réflexion fait-elle sur la mémoire collective ?', options: ['Qu’elle est toujours identique pour tout le monde', 'Qu’elle est faite de récits individuels multiples et parfois contradictoires', 'Qu’elle n’a aucune importance', 'Qu’elle ne change jamais'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Opinion vs fait : quelle phrase exprime une opinion ?', options: ['Le documentaire a été réalisé par un historien francophone.', 'C’est fascinant, mais aussi assez difficile à regarder.', 'Sa grand-mère raconte une histoire familiale.', 'Elle remercie sa grand-mère en fin de soirée.'], answer: 1 },
          { type: 'mcq', prompt: 'Conclusion : que représente la transmission de la mémoire, selon la fin du texte ?', options: ['Un simple exercice scolaire', 'Un acte intime qui relie les générations', 'Une perte de temps', 'Une obligation ennuyeuse'], answer: 1 },
          { type: 'mcq', prompt: 'Intention communicative : pourquoi demande-t-elle à sa grand-mère de lui raconter davantage d’histoires ?', options: ['Par simple politesse', 'Parce qu’elle veut sincèrement mieux comprendre d’où elle vient', 'Parce qu’un professeur le lui a demandé', 'Parce qu’elle doit écrire un devoir'], answer: 1 }
        ]
      }),
      listening: activity('listening', {
      ...
      dialogue: activity('dialogue', {
        title: 'Partager avec une amie',
        description: 'Une jeune femme raconte à une amie ce qu’elle a appris de sa grand-mère.',
        intro: 'Le lendemain, une jeune femme partage avec une amie l’histoire familiale qu’elle vient de découvrir.',
        dialogue: [
          { speaker: 'La jeune femme', line: 'Ma grand-mère m’a raconté une histoire familiale incroyable hier.', translation: 'Mi abuela me contó una historia familiar increíble ayer.' },
          { speaker: 'L’amie', line: 'Vraiment ? Raconte-moi tout !', translation: '¿En serio? ¡Cuéntamelo todo!' },
          { speaker: 'La jeune femme', line: 'C’est l’histoire de notre arrière-arrière-grand-mère, que je ne connaissais pas du tout.', translation: 'Es la historia de nuestra tatarabuela, que no conocía en absoluto.' },
          { speaker: 'L’amie', line: 'C’est précieux de connaître ce genre d’histoire, ça ne se perd pas facilement.', translation: 'Es valioso conocer ese tipo de historia, no se pierde fácilmente.' }
        ],
        phrases: ['Elle m’a raconté une histoire incroyable.', 'Raconte-moi tout !', 'Que je ne connaissais pas du tout.', 'C’est précieux de...'],
        exercises: [
          { type: 'mcq', prompt: 'Qu’a raconté la grand-mère ?', options: ['Une recette de cuisine', 'Une histoire familiale incroyable', 'Un problème de voisinage', 'Une histoire inventée'], answer: 1 },
          { type: 'mcq', prompt: 'La jeune femme connaissait-elle déjà cette histoire ?', options: ['Oui, très bien', 'Non, pas du tout', 'Un peu seulement', 'Elle ne le précise pas'], answer: 1 },
          { type: 'mcq', prompt: 'Que pense l’amie de cette découverte ?', options: ['Que ce n’est pas important', 'Que c’est précieux de connaître ce genre d’histoire', 'Qu’elle préfère ne pas en entendre parler', 'Qu’elle n’y croit pas'], answer: 1 }
        ]
      })
    }
  },
  // ---------------------------------------------------------------
  {
    ...
    activities: {
      reading: activity('reading', {
        ...
        description: 'Un groupe de bénévoles s’engage dans la protection des mangroves et rédige une demande de partenariat en français.',
        reading: {
          title: 'Sauver les mangroves',
          parts: [
            "Depuis quelques semaines, une jeune bénévole consacre une partie de ses week-ends à un groupe de jeunes engagés dans la protection des mangroves situées près de Saint-Domingue, un écosystème essentiel mais gravement menacé par la construction immobilière incontrôlée et la pollution plastique. « Les mangroves abritent une biodiversité extraordinaire, en plus de protéger la côte contre l'érosion », lui explique la coordinatrice du groupe, lors de sa première sortie sur le terrain. Immédiatement séduite par ce projet concret, elle décide de s'impliquer activement.",
            "Lorsque le groupe apprend qu'une association environnementale francophone basée en Guadeloupe mène des projets similaires de restauration de mangroves, la coordinatrice propose d'établir un partenariat afin que les deux organisations puissent échanger leurs connaissances et leurs méthodes de travail. Étant donné les compétences linguistiques de la jeune bénévole, on lui confie naturellement la tâche de rédiger le courrier officiel en français, afin que le message soit compris sans ambiguïté et transmette efficacement le sérieux de leur démarche.",
            "Dans sa lettre, elle explique en détail les actions déjà menées par le groupe : nettoyage régulier des zones côtières, plantation de nouvelles pousses de palétuviers, et sensibilisation des habitants locaux. « Je ne pense pas que ces problèmes environnementaux puissent être résolus isolément par un seul pays », écrit-elle avec conviction. « C'est pourquoi nous croyons qu'un partenariat international, aussi modeste soit-il au départ, pourrait avoir un impact bien plus important que des actions purement locales et isolées. » Elle ajoute que le climat des Caraïbes, plus vulnérable que celui de nombreuses autres régions du monde, exige une coopération régionale renforcée entre pays voisins, quelle que soit leur langue officielle.",
            "Quelques semaines après l'envoi de la lettre, l'association guadeloupéenne répond favorablement, proposant même d'organiser une visioconférence entre les deux groupes de bénévoles. Fière du rôle qu'elle a joué dans cette collaboration naissante, elle réalise à quel point ses compétences en français, qu'elle percevait initialement comme un simple atout académique, peuvent également devenir un véritable outil d'engagement citoyen et de solidarité internationale, bien au-delà de ce qu'elle avait imaginé au début de son apprentissage. Elle se promet, dès ce jour-là, de continuer à défendre ce type de coopération régionale tout au long de ses futures études universitaires."
          ],
          questions: [
            'Pourquoi les mangroves sont-elles importantes, selon la coordinatrice ?',
            'Pourquoi confie-t-on à la jeune bénévole la rédaction de la lettre en français ?',
          ...
          ordering: {
            ...
            events: [
              'Elle rejoint le groupe de protection des mangroves.',
              'La coordinatrice propose un partenariat avec une association guadeloupéenne.',
              'Elle rédige la lettre officielle en français.',
              'L’association guadeloupéenne répond favorablement.'
            ]
          }
        },
        exercises: [
          { type: 'mcq', prompt: 'Idée principale : de quoi parle ce texte ?', options: ['D’un voyage en Guadeloupe', 'De l’engagement d’une bénévole pour la protection des mangroves', 'D’un cours de biologie', 'D’un problème administratif'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Pourquoi lui confie-t-on la lettre ?', options: ['Parce qu’elle est la plus âgée', 'Grâce à ses compétences en français', 'Parce qu’elle a le plus de temps libre', 'Par tirage au sort'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Que pense-t-elle de la résolution isolée des problèmes environnementaux ?', options: ['Qu’elle est suffisante', 'Qu’elle n’est probablement pas suffisante', 'Elle n’a pas d’avis', 'Qu’elle est la seule solution possible'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Opinion vs fait : quelle phrase exprime une opinion ?', options: ['Le groupe nettoie les zones côtières.', 'Je ne pense pas que ces problèmes puissent être résolus isolément.', 'La coordinatrice dirige le groupe.', 'La lettre est envoyée en français.'], answer: 1 },
          { type: 'mcq', prompt: 'Inférence : que révèle cette expérience sur sa vision du français ?', options: ['Qu’elle regrette de l’avoir appris', 'Qu’il peut devenir un outil d’engagement citoyen, pas seulement académique', 'Qu’elle veut l’abandonner', 'Qu’il ne sert à rien dans la vie réelle'], answer: 1 },
      ...
      dialogue: activity('dialogue', {
        ...
        description: 'Une bénévole reçoit la réponse favorable de l’association guadeloupéenne et l’annonce au groupe.',
        intro: 'Une bénévole annonce avec enthousiasme la réponse reçue de l’association francophone.',
        dialogue: [
          { speaker: 'La bénévole', line: 'Ils ont répondu ! L’association guadeloupéenne accepte le partenariat !', translation: '¡Respondieron! ¡La asociación guadalupeña acepta la alianza!' },
          { speaker: 'La coordinatrice', line: 'C’est une excellente nouvelle, bravo pour cette lettre !', translation: '¡Es una excelente noticia, felicidades por esa carta!' },
          { speaker: 'La bénévole', line: 'Ils proposent même d’organiser une visioconférence entre nos deux groupes.', translation: 'Incluso proponen organizar una videoconferencia entre nuestros dos grupos.' },
          { speaker: 'La coordinatrice', line: 'Ton français nous a vraiment été utile pour ce projet.', translation: 'Tu francés realmente nos fue útil para este proyecto.' }
        ],
        phrases: ['Ils ont répondu !', 'C’est une excellente nouvelle.', 'Ils proposent de...', 'Ça nous a été utile.'],
        exercises: [
          { type: 'mcq', prompt: 'Quelle nouvelle la bénévole annonce-t-elle ?', options: ['Le refus du partenariat', 'L’acceptation du partenariat', 'Un problème technique', 'Un changement de projet'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Que dit la coordinatrice sur le rôle du français de la bénévole ?', options: ['Qu’il n’a servi à rien', 'Qu’il a été vraiment utile pour ce projet', 'Qu’elle aurait dû écrire en espagnol', 'Qu’elle ne comprend pas le français'], answer: 1 }
        ]
      })
    }
  },
  // ---------------------------------------------------------------
  {
    ...
    activities: {
      reading: activity('reading', {
        ...
        description: 'Une journaliste interviewe une artiste peintre franco-dominicaine pour un blog culturel, et découvre son processus créatif.',
        reading: {
          title: 'L’interview de l’artiste',
          parts: [
            "Pour une nouvelle série d'articles publiée sur un blog culturel, une journaliste décide d'interviewer une artiste peintre franco-dominicaine dont le travail, exposé récemment dans une petite galerie de Saint-Domingue, explore les thèmes de l'identité caribéenne et du métissage culturel. Avant leur rencontre, elle prépare soigneusement une liste de questions, consciente que la qualité de son interview dépendra autant de sa préparation que de sa capacité d'écoute pendant l'échange.",
            "Lors de l'entretien, l'artiste explique que son processus créatif commence toujours par une longue période d'observation, avant même de toucher un pinceau. « Je m'inspire énormément des couleurs et des textures que je retrouve dans mon quotidien : le bleu de la mer des Caraïbes, mais aussi celui du ciel de Bretagne où j'ai grandi », confie-t-elle. Elle ajoute que, plus elle avance dans sa carrière, plus elle se sent libre de mélanger des influences visuelles a priori très différentes, sans chercher à les opposer artificiellement.",
            "La journaliste lui demande alors si elle a déjà rencontré des difficultés à faire reconnaître un travail artistique qui refuse justement de se laisser enfermer dans une seule catégorie culturelle. L'artiste répond avec sincérité : « Au début de ma carrière, on me demandait souvent de choisir un camp, comme si je devais absolument me définir comme artiste française ou comme artiste caribéenne. Aujourd'hui, je reçois de moins en moins ce genre de remarque, sans doute parce que le public est devenu plus habitué à des identités multiples et complexes. » Elle explique également que sa dernière exposition, la plus personnelle qu'elle ait jamais réalisée, a été particulièrement bien accueillie par la critique, ce qui la conforte dans cette direction artistique.",
            "En terminant la rédaction de son article, la journaliste réalise à quel point cette conversation résonne avec sa propre expérience entre deux cultures. Elle décide de conclure son texte par une citation de l'artiste qui l'a particulièrement marquée : « Je ne crois pas qu'il faille choisir entre ses différentes appartenances culturelles. Au contraire, c'est précisément dans cette tension créative que naît, selon moi, ce qu'il y a de plus authentique dans une œuvre. » Elle publie son article avec une fierté particulière, consciente d'avoir su, cette fois-ci, poser les bonnes questions."
          ],
          questions: [
            'Quel thème l’œuvre de l’artiste explore-t-elle ?',
            'Comment l’artiste décrit-elle son processus créatif ?',
          ...
          ordering: {
            ...
            events: [
              'La journaliste prépare soigneusement une liste de questions.',
              'L’artiste explique son processus créatif basé sur l’observation.',
              'L’artiste parle de la difficulté initiale à faire reconnaître son travail hybride.',
              'La journaliste publie son article en concluant sur une citation de l’artiste.'
            ]
          }
        },
        exercises: [
          { type: 'mcq', prompt: 'Idée principale : de quoi parle ce texte ?', options: ['D’une exposition d’art à Paris', 'D’une interview avec une artiste franco-dominicaine', 'D’un cours de peinture', 'D’un problème avec un blog'], answer: 1 },
          { type: 'mcq', prompt: 'Information explicite : quel thème explore le travail de l’artiste ?', options: ['La politique internationale', 'L’identité caribéenne et le métissage culturel', 'L’histoire militaire', 'La cuisine française'], answer: 1 },
          { type: 'mcq', prompt: 'Comment commence son processus créatif ?', options: ['Par la vente de ses œuvres', 'Par une longue période d’observation', 'Par des cours en ligne', 'Par une lecture de journaux'], answer: 1 },
          { type: 'mcq', prompt: 'Que lui demandait-on souvent au début de sa carrière ?', options: ['De peindre plus vite', 'De choisir un camp culturel unique', 'D’arrêter de peindre', 'De vendre moins cher'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Opinion vs fait : quelle phrase exprime une opinion de l’artiste ?', options: ['L’artiste est franco-dominicaine.', 'Je ne crois pas qu’il faille choisir entre ses différentes appartenances culturelles.', 'La journaliste prépare une liste de questions.', 'L’exposition a eu lieu à Saint-Domingue.'], answer: 1 },
          { type: 'mcq', prompt: 'Inférence : pourquoi ce texte résonne-t-il particulièrement avec l’expérience de la journaliste ?', options: ['Parce qu’elle est aussi peintre', 'Parce qu’elle vit elle-même entre deux cultures', 'Par pur hasard', 'Parce qu’elle connaît l’artiste depuis l’enfance'], answer: 1 },
          { type: 'mcq', prompt: 'Conclusion : quel message central l’artiste transmet-elle à la fin de l’interview ?', options: ['Il faut absolument choisir une seule identité culturelle', 'La tension entre plusieurs appartenances peut être source d’authenticité créative', 'L’art n’a aucun lien avec l’identité', 'Il vaut mieux éviter de mélanger les cultures'], answer: 1 }
        ]
      }),
      listening: activity('listening', {
      ...
      dialogue: activity('dialogue', {
        ...
        description: 'L’artiste remercie la journaliste pour son article et ses questions.',
        intro: 'Après la publication de l’interview, l’artiste contacte la journaliste pour la remercier.',
        dialogue: [
          { speaker: 'L’artiste', line: 'J’ai lu votre article, il est vraiment très juste.', translation: 'Leí su artículo, es realmente muy acertado.' },
          { speaker: 'La journaliste', line: 'Merci beaucoup, j’ai adoré cette conversation avec vous.', translation: 'Muchas gracias, me encantó esta conversación con usted.' },
          { speaker: 'L’artiste', line: 'Vos questions étaient particulièrement pertinentes, on sentait une vraie curiosité.', translation: 'Sus preguntas fueron particularmente pertinentes, se sentía una verdadera curiosidad.' },
          { speaker: 'La journaliste', line: 'C’est un sujet qui me touche personnellement, ça a dû s’entendre.', translation: 'Es un tema que me toca personalmente, seguramente se notó.' }
        ],
        phrases: ['J’ai lu votre article.', 'J’ai adoré cette conversation.', 'Vos questions étaient pertinentes.', 'Ça a dû s’entendre.'],
        exercises: [
          { type: 'mcq', prompt: 'Que pense l’artiste de l’article ?', options: ['Qu’il est mauvais', 'Qu’il est vraiment très juste', 'Qu’il est trop court', 'Elle ne l’a pas lu'], answer: 1 },
          { type: 'mcq', prompt: 'Comment l’artiste qualifie-t-elle les questions de la journaliste ?', options: ['Sans intérêt', 'Particulièrement pertinentes', 'Trop personnelles', 'Répétitives'], answer: 1 },
          { type: 'mcq', prompt: 'Pourquoi la journaliste pense-t-elle que sa curiosité s’est ressentie ?', options: ['Parce qu’elle a menti', 'Parce que le sujet la touche personnellement', 'Par hasard', 'Elle ne le pense pas'], answer: 1 }
        ]
      })
    }
  },
  // ---------------------------------------------------------------
  {
    ...
    activities: {
      reading: activity('reading', {
        ...
        exercises: [
          { type: 'mcq', prompt: 'Idée principale : de quoi parle ce texte ?', options: ['D’un examen raté', 'Du bilan que fait une jeune femme de son parcours après avoir été acceptée à l’université', 'D’une dispute familiale', 'D’un voyage touristique'], answer: 1 },
          { type: 'mcq', prompt: 'Information explicite : à quelle formation est-elle acceptée ?', options: ['Un master de commerce', 'Une licence de langues étrangères appliquées', 'Un diplôme de médecine', 'Une école d’art'], answer: 1 },
          { type: 'mcq', prompt: 'À qui écrit-elle sa lettre ?', options: ['À sa mère', 'À la version d’elle-même d’il y a deux ans', 'À l’université de Tours', 'À une artiste'], answer: 1 },
          { type: 'mcq', prompt: 'Que dit-elle sur les difficultés de son année en France ?', options: ['Qu’il n’y en a eu aucune', 'Qu’elle admet honnêtement qu’il y a eu des moments difficiles', 'Qu’elle les cache complètement', 'Qu’elle regrette tout'], answer: 1 },
          { type: 'mcq', prompt: 'Qu’aurait-elle manqué si elle avait annulé son voyage ?', options: ['Rien d’important', 'Ses amitiés, sa passion pour la traduction, son engagement pour les mangroves', 'Seulement de meilleures notes', 'Un diplôme supplémentaire'], answer: 1 },
          { type: 'mcq', prompt: 'Quel conseil final donne-t-elle à son ancien moi ?', options: ['D’éviter tout risque', 'D’être déterminée, curieuse, et de ne pas avoir peur de se tromper', 'De rester chez elle', 'De ne faire confiance à personne'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Inférence : pourquoi publie-t-elle cette lettre sur son blog plutôt que de la garder privée ?', options: ['Par erreur', 'Parce qu’elle espère qu’elle résonnera avec d’autres jeunes dans une situation similaire', 'Parce qu’on l’y oblige', 'Parce qu’elle veut se vanter'], answer: 1 },
      ...
      grammar: activity('grammar', {
        ...
        exercises: [
          { type: 'mcq', prompt: 'Si elle ___ ce voyage, elle n’aurait jamais rencontré ses amis les plus chers.', options: ['annule', 'avait annulé', 'annulerait', 'annulait'], answer: 1 },
      ...
      dialogue: activity('dialogue', {
        ...
        description: 'Une jeune femme partage avec sa grand-mère sa décision de repartir étudier en France.',
        intro: 'Une jeune femme annonce à sa grand-mère qu’elle repart bientôt en France pour ses études.',
        dialogue: [
          { speaker: 'La petite-fille', line: 'Grand-mère, je pars étudier à Tours à la rentrée prochaine.', translation: 'Abuela, me voy a estudiar a Tours el próximo curso.' },
          { speaker: 'La grand-mère', line: 'Je suis tellement fière de toi, ma chérie.', translation: 'Estoy tan orgullosa de ti, cariño.' },
          { speaker: 'La petite-fille', line: 'Merci, grand-mère. Cette fois, je pars avec beaucoup plus de confiance.', translation: 'Gracias, abuela. Esta vez me voy con mucha más confianza.' },
        ...
        exercises: [
          { type: 'mcq', prompt: 'Quelle nouvelle annonce-t-elle à sa grand-mère ?', options: ['Qu’elle reste définitivement à Saint-Domingue', 'Qu’elle repart étudier à Tours', 'Qu’elle change de métier', 'Qu’elle arrête ses études'], answer: 1 },
          ...
          { type: 'mcq', prompt: 'Comment ce départ diffère-t-il du premier, selon elle ?', options: ['Il est identique', 'Elle part avec beaucoup plus de confiance', 'Elle part à contrecœur', 'Elle ne veut pas partir'], answer: 1 }
        ]
      })
    }
  }
...
const REAL_B2_READINGS = {
  'retour-a-saint-domingue': {
    ...
    exercises: [
      { type: 'mcq', prompt: 'Qui a décrit pour la première fois le « choc culturel inversé », et en quelle année ?', options: ['John et Jeanne Gullahorn, en 1963', 'Kalervo Oberg, en 1990', 'Un ministère de l’Éducation, en 2000', 'Le texte ne précise pas de date'], answer: 0 },
      { type: 'mcq', prompt: 'Comment s’appelle le modèle en plusieurs phases décrit dans le texte ?', options: ['La courbe en W', 'Le cercle vicieux', 'La spirale du silence', 'Le triangle de l’adaptation'], answer: 0 },
      { type: 'mcq', prompt: 'Selon le texte, à quoi tient souvent ce « mal du pays » ressenti au retour ?', options: ['À des détails concrets comme un plat ou un rythme de vie précis', 'À un problème administratif lié au visa', 'Uniquement à la météo du pays d’accueil', 'Le texte affirme qu’il n’a aucune cause identifiable'], answer: 0 },
      { type: 'mcq', prompt: 'Que révèlent les enquêtes menées auprès d’anciens participants à des programmes d’échange ?', options: ['Plus l’immersion avait été intense, plus le retour se révélait difficile', 'Le retour est toujours plus facile que le départ', 'L’immersion linguistique n’a aucun effet sur le retour', 'Les échanges courts sont toujours plus difficiles à vivre'], answer: 0 },
      { type: 'mcq', prompt: 'Que recommandent les services d’orientation universitaire pour atténuer ce choc ?', options: ['Rompre tout contact avec l’étranger visité', 'Maintenir les amitiés nouées et poursuivre la pratique linguistique', 'Éviter d’en parler avant le départ', 'Refuser toute nouvelle mobilité à l’avenir'], answer: 1 }
    ]
  },
  'candidature-universitaire': {
    ...
    exercises: [
      { type: 'mcq', prompt: 'Combien de vœux la plateforme Parcoursup traite-t-elle chaque année, selon le texte ?', options: ['Plus de dix millions', 'Environ mille', 'Cent mille', 'Le texte ne donne aucun chiffre'], answer: 0 },
      { type: 'mcq', prompt: 'Pourquoi une lettre trop générale a-t-elle peu de chances de retenir l’attention d’un jury ?', options: ['Parce qu’elle est trop courte', 'Parce qu’elle pourrait être envoyée telle quelle à n’importe quelle formation', 'Parce qu’elle contient trop de fautes', 'Parce qu’elle est trop personnelle'], answer: 1 },
      { type: 'mcq', prompt: 'Quelle est la structure en trois temps recommandée dans le texte ?', options: ['Déclencheur, exemples concrets, ce que le candidat apportera', 'Introduction, biographie complète, conclusion', 'Salutations, notes scolaires, remerciements', 'Question, réponse, opinion personnelle'], answer: 0 },
      { type: 'mcq', prompt: 'Qu’est-ce qui démontre, selon le texte, un engagement authentique envers une formation ?', options: ['Mentionner un enseignant précis ou un projet de recherche du département', 'Utiliser un vocabulaire très soutenu', 'Écrire une lettre très longue', 'Citer des proverbes célèbres'], answer: 0 },
      { type: 'mcq', prompt: 'Que cherchent avant tout les commissions d’admission, selon la conclusion du texte ?', options: ['La longueur du texte', 'Le style littéraire uniquement', 'La cohérence entre le parcours du candidat et le projet présenté', 'Le nombre de formations mentionnées'], answer: 2 }
    ]
  },
  'debats-de-societe': {
    ...
    exercises: [
      { type: 'mcq', prompt: 'Quel chiffre le texte cite-t-il concernant le temps d’écran quotidien des adolescents français ?', options: ['Trois heures et quart', 'Une demi-heure', 'Huit heures', 'Le texte ne donne aucun chiffre'], answer: 0 },
      { type: 'mcq', prompt: 'Selon certains chercheurs en psychologie du développement, qu’est-ce qui importe le plus que la durée d’exposition ?', options: ['Le prix de l’appareil utilisé', 'Le type de contenu consommé et le contexte', 'La marque du téléphone', 'L’heure exacte de la journée uniquement'], answer: 1 },
      { type: 'mcq', prompt: 'À quel phénomène la chercheuse Jean Twenge associe-t-elle l’architecture des plateformes numériques ?', options: ['La hausse des troubles anxieux chez les adolescents nés après le milieu des années 1990', 'La baisse du niveau scolaire général', 'L’augmentation du sport pratiqué', 'La diminution du temps de sommeil des adultes'], answer: 0 },
      { type: 'mcq', prompt: 'Que font certains pays face à ce débat, selon le texte ?', options: ['Ils légifèrent sur l’accès des mineurs aux réseaux sociaux', 'Ils interdisent tous les écrans dans le monde entier', 'Ils ignorent totalement la question', 'Ils suppriment l’école'], answer: 0 },
      { type: 'mcq', prompt: 'Quelle stratégie est jugée plus efficace qu’une interdiction rigide, selon la conclusion du texte ?', options: ['La confiscation systématique des appareils', 'Un dialogue ouvert entre parents et adolescents', 'L’absence totale de règles', 'Une loi identique dans tous les pays'], answer: 1 }
    ]
  },
  'le-teletravail-et-lavenir-professionnel': {
    ...
    exercises: [
      { type: 'mcq', prompt: 'Quel économiste est mentionné dans le texte pour ses enquêtes trimestrielles sur le télétravail ?', options: ['Nicholas Bloom', 'Thomas Piketty', 'Jean Tirole', 'Le texte ne mentionne aucun économiste'], answer: 0 },
      { type: 'mcq', prompt: 'Que montrent certaines études sur la productivité en télétravail ?', options: ['Une baisse systématique de l’efficacité', 'Une hausse de l’efficacité individuelle liée notamment à la réduction des trajets', 'Aucun effet mesurable', 'Une productivité identique dans tous les cas'], answer: 1 },
      { type: 'mcq', prompt: 'Quel type de transmission de connaissances est menacé par le télétravail, selon le texte ?', options: ['La transmission informelle, comme celle qui se produit autour d’une machine à café', 'La transmission par courrier officiel', 'La transmission via des manuels papier', 'Aucune transmission n’est mentionnée'], answer: 0 },
      { type: 'mcq', prompt: 'Quel risque est particulièrement bien documenté par les chercheurs en psychologie du travail ?', options: ['L’isolement social des salariés totalement à distance', 'L’augmentation du bruit au bureau', 'La perte totale de compétences', 'Le manque d’équipement informatique'], answer: 0 },
      { type: 'mcq', prompt: 'Sur quel point la plupart des spécialistes des ressources humaines s’accordent-ils, selon la conclusion ?', options: ['Il existe une formule universelle valable pour toutes les entreprises', 'Il n’existe pas de formule universelle ; l’organisation compte plus que le nombre de jours', 'Le télétravail devrait être totalement interdit', 'Le télétravail n’a aucun avenir'], answer: 1 }
    ]
  },
  'litterature-francophone': {
    ...
    exercises: [
      { type: 'mcq', prompt: 'Par quelle déclaration s’ouvre l’essai « Éloge de la créolité », selon le texte ?', options: ['« Ni Européens, ni Africains, ni Asiatiques, nous nous proclamons Créoles »', 'Une dédicace à Aimé Césaire', 'Une citation de Victor Hugo', 'Un poème en créole seul'], answer: 0 },
      { type: 'mcq', prompt: 'Quel concept Édouard Glissant a-t-il développé, selon le texte ?', options: ['La créolisation', 'La négritude', 'Le réalisme magique', 'Le romantisme'], answer: 0 },
      { type: 'mcq', prompt: 'Que répondait Chamoiseau lorsqu’on l’interrogeait sur sa langue d’écriture ?', options: ['Qu’il refusait de choisir entre le français et le créole', 'Qu’il écrivait uniquement en créole', 'Qu’il n’écrivait qu’en français standard', 'Qu’il ne s’exprimait jamais sur ce sujet'], answer: 0 },
      { type: 'mcq', prompt: 'Comment Maryse Condé répondait-elle quand on lui demandait si elle se sentait « créoliste » ?', options: ['Qu’elle appartenait avant tout à elle-même', 'Qu’elle était la fondatrice du mouvement', 'Qu’elle rejetait toute forme d’identité antillaise', 'Qu’elle n’avait jamais entendu parler de ce mouvement'], answer: 0 },
      { type: 'mcq', prompt: 'Quelle distinction Maryse Condé a-t-elle reçue en 2018, selon le texte ?', options: ['Le prix Goncourt', 'Le prix Nobel alternatif de littérature', 'Le prix Nobel de la paix', 'Aucune distinction internationale'], answer: 1 }
    ]
  },
  'cinema-et-critique': {
    ...
    exercises: [
      { type: 'mcq', prompt: 'Quelle récompense Justine Triet a-t-elle obtenue à Cannes en mai 2023, selon le texte ?', options: ['Le prix du jury', 'La Palme d’or', 'Le César du meilleur film', 'Aucune récompense'], answer: 1 },
      { type: 'mcq', prompt: 'Que raconte le film, selon le texte ?', options: ['Le procès d’une écrivaine soupçonnée d’avoir tué son mari retrouvé mort au pied d’un chalet', 'Une histoire d’amour à Paris', 'Un documentaire sur la montagne', 'Une comédie familiale'], answer: 0 },
      { type: 'mcq', prompt: 'Ce que le film refuse de faire, selon le texte, c’est...', options: ['Trancher avec certitude sur ce qui s’est réellement passé', 'Montrer le procès en détail', 'Utiliser des dialogues', 'Se dérouler dans les Alpes'], answer: 0 },
      { type: 'mcq', prompt: 'Quelle récompense le scénario du film a-t-il reçue en 2024, selon le texte ?', options: ['L’Oscar du meilleur scénario original', 'Le César du meilleur scénario', 'Le prix Goncourt', 'Aucune récompense supplémentaire'], answer: 0 },
      { type: 'mcq', prompt: 'Quel débat plus large ce film a-t-il relancé, selon la conclusion du texte ?', options: ['La place des femmes derrière la caméra à Cannes', 'Le prix des places de cinéma', 'La disparition du cinéma français', 'Le rôle des acteurs allemands en France'], answer: 0 }
    ]
  },
  'dilemmes-ethiques': {
    ...
    exercises: [
      { type: 'mcq', prompt: 'Qui a formulé pour la première fois le dilemme du tramway, et en quelle année ?', options: ['Philippa Foot, en 1967', 'Un chercheur du MIT, en 2018', 'Aristote, dans l’Antiquité', 'Un ingénieur automobile, en 2000'], answer: 0 },
      { type: 'mcq', prompt: 'Selon l’approche déontologique, qu’aurait-on commis en transformant une personne en simple moyen pour atteindre une fin ?', options: ['Une faute morale, quel que soit le résultat', 'Un acte parfaitement justifié', 'Une erreur de calcul uniquement', 'Un acte sans aucune conséquence'], answer: 0 },
      { type: 'mcq', prompt: 'Que montre la variante du dilemme où il faudrait pousser physiquement une personne sur la voie ?', options: ['Que l’intuition morale des individus ne suit pas toujours une logique cohérente', 'Que personne ne réagit jamais différemment', 'Que ce dilemme n’intéresse plus les chercheurs', 'Que la version originale du dilemme a été abandonnée'], answer: 0 },
      { type: 'mcq', prompt: 'Qu’est-ce que la plateforme « Moral Machine » du MIT, selon le texte ?', options: ['Un jeu vidéo commercial', 'Une plateforme ayant recueilli les préférences morales de millions de participants sur des scénarios liés aux voitures autonomes', 'Un tramway expérimental', 'Un cours de philosophie en ligne uniquement'], answer: 1 },
      { type: 'mcq', prompt: 'Où et quand les résultats de l’étude sur la Moral Machine ont-ils été publiés ?', options: ['Dans la revue Nature, en 2018', 'Dans un journal local, en 1967', 'Ils n’ont jamais été publiés', 'Sur un blog personnel, en 2020'], answer: 0 }
    ]
  },
  'sciences-et-innovations': {
    ...
    exercises: [
      { type: 'mcq', prompt: 'Quel pourcentage d’emplois dans le monde pourrait être affecté par l’IA, selon le rapport du FMI cité dans le texte ?', options: ['Près de 40 %', 'Environ 5 %', '100 %', 'Le texte ne donne aucun chiffre'], answer: 0 },
      { type: 'mcq', prompt: 'Que précisent aussitôt les auteurs du rapport du FMI concernant le mot « affecté » ?', options: ['Que cela ne signifie pas nécessairement « supprimé »', 'Que cela signifie toujours une suppression totale', 'Que ce mot ne concerne que les métiers manuels', 'Que le rapport ne définit pas ce terme'], answer: 0 },
      { type: 'mcq', prompt: 'Quel exemple le texte donne-t-il d’un métier transformé plutôt qu’automatisé ?', options: ['La traduction, où l’IA assiste sans remplacer complètement les traducteurs humains', 'L’agriculture', 'La médecine chirurgicale', 'La construction'], answer: 0 },
      { type: 'mcq', prompt: 'Que souligne une étude de l’OCDE de 2023 citée dans le texte ?', options: ['Que la maîtrise technique seule suffit pour s’adapter', 'Que les compétences difficilement automatisables (jugement, créativité, intelligence relationnelle) sont essentielles', 'Que la formation continue est inutile', 'Que tous les emplois vont disparaître'], answer: 1 },
      { type: 'mcq', prompt: 'Quel est l’enjeu principal identifié par les experts dans la conclusion du texte ?', options: ['La capacité des machines à tout automatiser', 'La façon dont les sociétés organiseront collectivement cette transition', 'Le prix des ordinateurs', 'L’arrêt complet du développement de l’IA'], answer: 1 }
    ]
  },
  'histoire-et-memoire': {
    ...
    exercises: [
      { type: 'mcq', prompt: 'En quelle année Haïti a-t-elle obtenu son indépendance, selon le texte ?', options: ['1804', '1844', '1937', '1492'], answer: 0 },
      { type: 'mcq', prompt: 'En quelle année la partie orientale de l’île a-t-elle accédé à une indépendance durable, selon le texte ?', options: ['1804', '1844', '1937', '1900'], answer: 1 },
      { type: 'mcq', prompt: 'Qui a ordonné le massacre de 1937 mentionné dans le texte ?', options: ['Rafael Trujillo', 'Un roi espagnol', 'Un gouverneur français', 'Un président haïtien'], answer: 0 },
      { type: 'mcq', prompt: 'Quand cet épisode a-t-il été documenté précisément par les historiens, selon le texte ?', options: ['Immédiatement après les faits', 'Seulement plusieurs décennies plus tard', 'Il ne l’a jamais été', 'Dès le dix-neuvième siècle'], answer: 1 },
      { type: 'mcq', prompt: 'Que tentent de faire plusieurs initiatives culturelles récentes, selon la conclusion du texte ?', options: ['Effacer complètement cette histoire', 'Favoriser un dialogue historique plus ouvert entre les deux pays', 'Empêcher toute recherche sur le sujet', 'Réécrire l’histoire de façon unilatérale'], answer: 1 }
    ]
  },
  'ecologie-et-engagement-citoyen': {
    ...
    exercises: [
      { type: 'mcq', prompt: 'Combien de fois plus de carbone les mangroves stockent-elles, à surface égale, par rapport aux forêts tropicales terrestres, selon le texte ?', options: ['Jusqu’à deux fois plus', 'Jusqu’à quatre fois plus', 'Dix fois plus', 'Le texte ne précise pas de chiffre'], answer: 1 },
      { type: 'mcq', prompt: 'Quel rôle jouent les mangroves pour les communautés de pêcheurs locaux, selon le texte ?', options: ['Aucun rôle particulier', 'Elles servent de zone de reproduction pour de nombreuses espèces de poissons', 'Elles empêchent totalement la pêche', 'Elles ne concernent que le tourisme'], answer: 1 },
      { type: 'mcq', prompt: 'Qu’ont montré plusieurs études menées après des ouragans dans la région caribéenne ?', options: ['Que les mangroves n’ont aucun effet protecteur', 'Que les zones protégées par des mangroves en bonne santé subissaient moins de dégâts', 'Que les mangroves aggravent les tempêtes', 'Que les ouragans détruisent toujours les mangroves entièrement'], answer: 1 },
      { type: 'mcq', prompt: 'Quelles sont les principales causes du recul des mangroves mentionnées dans le texte ?', options: ['La construction immobilière côtière, la pollution plastique et l’aquaculture intensive', 'Uniquement le changement de température', 'Les tremblements de terre', 'La chasse aux animaux marins'], answer: 0 },
      { type: 'mcq', prompt: 'Que réclament plusieurs organisations régionales, selon la conclusion du texte ?', options: ['Une coopération renforcée entre pays voisins des Caraïbes', 'La fin de toute coopération régionale', 'L’arrêt complet des programmes de restauration', 'Une frontière stricte entre les écosystèmes'], answer: 0 }
    ]
  },
  'art-et-creativite': {
    ...
    exercises: [
      { type: 'mcq', prompt: 'En quelle année et où Wifredo Lam est-il né, selon le texte ?', options: ['En 1902, à Cuba', 'En 1943, en France', 'En 1980, en Espagne', 'En 1920, en Chine'], answer: 0 },
      { type: 'mcq', prompt: 'Qui Wifredo Lam a-t-il fréquenté à Paris, selon le texte ?', options: ['Picasso et les surréalistes autour d’André Breton', 'Des politiciens uniquement', 'Aucun artiste connu', 'Des musiciens de jazz uniquement'], answer: 0 },
      { type: 'mcq', prompt: 'Quel est le tableau le plus célèbre de Lam mentionné dans le texte, et où est-il conservé ?', options: ['« La Jungle », au Museum of Modern Art de New York', '« Guernica », au musée Reina Sofía', '« Les Demoiselles », au Louvre', 'Un tableau non précisé, au Centre Pompidou'], answer: 0 },
      { type: 'mcq', prompt: 'Quelles influences se mêlent dans « La Jungle », selon le texte ?', options: ['Le surréalisme européen, la santería cubaine et l’art africain', 'Uniquement l’art chinois', 'Le cubisme et l’impressionnisme seuls', 'Aucune influence particulière'], answer: 0 },
      { type: 'mcq', prompt: 'Comment le parcours de Lam est-il considéré aujourd’hui par de nombreux historiens de l’art, selon la conclusion ?', options: ['Comme un échec artistique', 'Comme un exemple abouti d’identité construite à travers plusieurs héritages culturels', 'Comme une simple imitation du surréalisme européen', 'Comme sans importance pour l’art contemporain'], answer: 1 }
    ]
  },
  'bilan-et-projets-davenir': {
    ...
    exercises: [
      { type: 'mcq', prompt: 'Depuis quelle année le programme Erasmus existe-t-il, et combien de jeunes en ont bénéficié, selon le texte ?', options: ['Depuis 1987, plus de treize millions de jeunes', 'Depuis 2000, environ mille jeunes', 'Depuis 1957, aucun chiffre n’est donné', 'Le texte ne précise ni date ni chiffre'], answer: 0 },
      { type: 'mcq', prompt: 'Que révèle l’enquête de la Commission européenne sur les anciens étudiants Erasmus, selon le texte ?', options: ['Un taux d’insertion professionnelle nettement supérieur à celui des étudiants sans mobilité', 'Un taux de chômage plus élevé', 'Aucune différence mesurable', 'Un désintérêt pour le monde professionnel'], answer: 0 },
      { type: 'mcq', prompt: 'Comment les chercheurs expliquent-ils cet écart d’insertion professionnelle ?', options: ['Par le hasard uniquement', 'Par le développement de compétences interculturelles et d’une plus grande adaptabilité', 'Par un meilleur salaire de départ', 'Par une chance particulière'], answer: 1 },
      { type: 'mcq', prompt: 'Que veut dire « la tolérance à l’ambiguïté », telle que définie dans le texte ?', options: ['La capacité à avancer sereinement sans avoir toutes les réponses immédiatement', 'La capacité à mentir facilement', 'Le refus de toute décision', 'L’incapacité à s’adapter'], answer: 0 },
      { type: 'mcq', prompt: 'Quelle est la conclusion générale des études longitudinales citées dans le texte ?', options: ['L’impact de la mobilité internationale se limite à la durée du séjour', 'L’impact se prolonge bien au-delà du séjour, influençant durablement les décisions futures', 'La mobilité internationale n’a aucun effet mesurable', 'Seul le diplôme obtenu compte réellement'], answer: 1 }
    ]
  }
};
...
units.forEach((unit) => {
  ...
  const realReading = REAL_B2_READINGS[unit.slug];
...
module.exports = {
  ...
  courseDescription:
    'Français avancé : argumentation, société, culture et projets académiques, organisés en unités thématiques ancrées dans des sujets réels et documentés.',
  units
};
