...
const REAL_B2_READINGS = {
  'retour-a-saint-domingue': {
    ...
    exercises: [
      { type: 'mcq', prompt: 'Comment les chercheurs appellent-ils la difficulté ressentie au retour d’un séjour à l’étranger ?', options: ['Le choc culturel inversé', 'La fatigue du voyage', 'Le syndrome de l’expatriation', 'La barrière linguistique'], answer: 0 },
      { type: 'mcq', prompt: 'Depuis quand ce phénomène est-il décrit par les chercheurs, selon le texte ?', options: ['Depuis les années 2010', 'Depuis les années 1960', 'Depuis le vingtième siècle uniquement', 'Le texte ne le précise pas'], answer: 1 },
      { type: 'mcq', prompt: 'Qu’est-ce qui a le plus souvent changé, selon les études citées ?', options: ['Le pays d’origine lui-même', 'La personne qui revient, plus que le lieu', 'La langue officielle du pays', 'Rien n’a réellement changé'], answer: 1 },
      { type: 'mcq', prompt: 'Quelle stratégie les spécialistes recommandent-ils pour atténuer ce trouble ?', options: ['Oublier rapidement l’expérience vécue à l’étranger', 'Garder contact avec les amitiés nouées et continuer à pratiquer la langue', 'Éviter tout contact avec l’étranger visité', 'Refuser de reparler de son séjour'], answer: 1 },
      { type: 'mcq', prompt: 'Que proposent désormais certaines universités et organismes d’échange ?', options: ['Des ateliers d’accompagnement au retour', 'Des tests médicaux obligatoires', 'Des interdictions de repartir à l’étranger', 'Rien de particulier'], answer: 0 },
      { type: 'mcq', prompt: 'Quelle conclusion générale le texte tire-t-il sur le retour ?', options: ['Il faut le considérer comme un échec', 'C’est une étape à part entière du parcours de mobilité', 'Il vaut mieux ne jamais revenir', 'Il ne mérite aucune attention particulière'], answer: 1 }
    ]
  },
  'candidature-universitaire': {
    title: 'Bien rédiger sa lettre de motivation',
    description: 'Les conseils des services d’orientation universitaire pour structurer une candidature convaincante.',
    parts: [
      "Chaque année, les services d’orientation des universités françaises reçoivent des milliers de questions de candidats qui se demandent comment rédiger une lettre de motivation efficace. Contrairement à une idée répandue, il ne s’agit pas de multiplier les formules élogieuses ni de résumer l’ensemble de son parcours scolaire : la lettre doit avant tout démontrer que le candidat a compris les spécificités de la formation visée et qu’il est capable d’expliquer, avec des exemples précis, ce qui motive réellement son choix.",
      ...
      "En définitive, une bonne lettre de motivation ne cherche pas à impressionner à tout prix, mais à établir une cohérence claire entre le passé du candidat, ses expériences vécues et le projet qu’il présente. C’est cette cohérence, davantage que le style ou la longueur du texte, que les commissions d’admission cherchent avant tout à identifier lorsqu’elles examinent des centaines de dossiers chaque année."
    ],
    exercises: [
      { type: 'mcq', prompt: 'Que doit avant tout démontrer une lettre de motivation, selon le texte ?', options: ['Que le candidat a compris les spécificités de la formation visée', 'Que le candidat a les meilleures notes possibles', 'Que le candidat connaît beaucoup de vocabulaire soutenu', 'Que le candidat a voyagé dans plusieurs pays'], answer: 0 },
      { type: 'mcq', prompt: 'Quelle est la structure en trois temps recommandée par les conseillers pédagogiques ?', options: ['Déclencheur, exemples concrets, ce que le candidat apportera', 'Introduction, biographie complète, conclusion', 'Salutations, notes scolaires, remerciements', 'Question, réponse, opinion personnelle'], answer: 0 },
      { type: 'mcq', prompt: 'Pourquoi la dernière étape (ce que le candidat apportera) est-elle souvent négligée mais importante ?', options: ['Parce qu’elle est obligatoire administrativement', 'Parce qu’elle distingue un projet réfléchi d’une simple liste de vœux', 'Parce qu’elle est la plus facile à écrire', 'Parce qu’elle remplace toutes les autres parties'], answer: 1 },
      { type: 'mcq', prompt: 'Quelle est l’erreur la plus fréquente relevée par les responsables d’admission ?', options: ['Une lettre trop courte', 'Une lettre trop générale, sans spécificité', 'Une lettre trop personnelle', 'Une lettre sans salutations formelles'], answer: 1 },
      { type: 'mcq', prompt: 'Que recommandent les conseillers concernant l’équilibre entre confiance et humilité ?', options: ['Valoriser ses réussites sans exagérer, et reconnaître les difficultés surmontées', 'Ne jamais mentionner de difficulté', 'Exagérer systématiquement ses compétences', 'Éviter toute mention personnelle'], answer: 0 },
      { type: 'mcq', prompt: 'Quel élément les commissions d’admission cherchent-elles avant tout, selon la conclusion du texte ?', options: ['La longueur du texte', 'Le style littéraire uniquement', 'La cohérence entre le parcours, les expériences et le projet présenté', 'Le nombre de langues mentionnées'], answer: 2 }
    ]
  },
  'debats-de-societe': {
    ...
    exercises: [
      ...
      { type: 'mcq', prompt: 'Que soulignent les partisans d’une régulation plus stricte ?', options: ['Que les plateformes sont conçues pour maximiser le temps de connexion', 'Que les écrans n’ont jamais d’effet', 'Que les parents ne devraient pas s’impliquer', 'Que l’éducation aux médias est inutile'], answer: 0 },
      { type: 'mcq', prompt: 'Que font certains pays face à ce débat ?', options: ['Ils légifèrent sur l’accès des mineurs aux réseaux sociaux', 'Ils interdisent tous les écrans dans le monde entier', 'Ils ignorent totalement la question', 'Ils suppriment l’école'], answer: 0 },
      { type: 'mcq', prompt: 'Quelle difficulté plus large ce débat illustre-t-il, selon le texte ?', options: ['Légiférer sur un phénomène qui évolue plus vite que les études scientifiques', 'Le manque total de recherches sur le sujet', 'L’absence complète d’opinions publiques', 'Le désintérêt des chercheurs pour ce sujet'], answer: 0 },
      { type: 'mcq', prompt: 'Quelle stratégie la plupart des experts associent-ils à un usage équilibré des écrans ?', options: ['Une interdiction rigide et unilatérale', 'Un dialogue ouvert entre parents et adolescents', 'L’absence totale de règles', 'La confiscation systématique des appareils'], answer: 1 }
    ]
  },
  'le-teletravail-et-lavenir-professionnel': {
    ...
    exercises: [
      { type: 'mcq', prompt: 'Depuis quand le télétravail s’est-il généralisé de façon spectaculaire en France, selon le texte ?', options: ['Depuis les années 1990', 'Depuis 2020', 'Depuis toujours', 'Le texte ne le précise pas'], answer: 1 },
      ...
      { type: 'mcq', prompt: 'Quel effet négatif d’autres travaux pointent-ils concernant le télétravail ?', options: ['Une baisse de la collaboration et de la transmission informelle de connaissances', 'Une augmentation du salaire', 'Une diminution du nombre d’employés', 'Un manque d’ordinateurs'], answer: 0 },
      ...
      { type: 'mcq', prompt: 'Que font un nombre croissant d’entreprises face au risque d’isolement ?', options: ['Elles interdisent totalement le télétravail', 'Elles imposent un minimum de jours de présence hebdomadaire', 'Elles suppriment les bureaux', 'Elles ignorent le problème'], answer: 1 },
  ...
  'litterature-francophone': {
    ...
    parts: [
      ...
      "Ce que ces auteurs ont en commun, malgré leurs désaccords théoriques, c’est la conviction que la littérature caribéenne francophone ne saurait se laisser enfermer dans une seule catégorie identitaire. Aujourd’hui encore, cette question continue d’alimenter la réflexion de nombreux écrivains de la région, dont les œuvres sont désormais étudiées dans les universités du monde entier comme un exemple particulièrement riche de littérature construite entre plusieurs langues et plusieurs mondes."
    ],
    exercises: [
      { type: 'mcq', prompt: 'Qui a publié l’essai « Éloge de la créolité » ?', options: ['Trois écrivains martiniquais : Bernabé, Chamoiseau et Confiant', 'Un seul auteur français', 'Un collectif d’universités africaines', 'Aimé Césaire seul'], answer: 0 },
      { type: 'mcq', prompt: 'Que défend l’essai « Éloge de la créolité » ?', options: ['Que l’identité antillaise est une simple extension de la culture française', 'Que l’identité antillaise est une réalité culturelle propre, née du métissage', 'Qu’il faut retourner uniquement vers une Afrique ancestrale', 'Que la culture caribéenne n’existe pas'], answer: 1 },
      { type: 'mcq', prompt: 'Quel concept Édouard Glissant a-t-il développé ?', options: ['La créolisation', 'La négritude', 'Le réalisme magique', 'Le romantisme'], answer: 0 },
      { type: 'mcq', prompt: 'Quel roman de Chamoiseau a obtenu le prix Goncourt en 1992 ?', options: ['Texaco', 'Ségou', 'Moi, Tituba sorcière', 'La créolité'], answer: 0 },
      { type: 'mcq', prompt: 'Quelle position Maryse Condé a-t-elle adoptée par rapport au mouvement de la créolité ?', options: ['Elle l’a rejoint officiellement', 'Elle a préféré une position plus individuelle, sans rattachement collectif', 'Elle a fondé ce mouvement', 'Elle n’a jamais écrit sur ce sujet'], answer: 1 },
      { type: 'mcq', prompt: 'Quelle distinction Maryse Condé a-t-elle reçue en 2018 ?', options: ['Le prix Goncourt', 'Le prix Nobel alternatif de littérature', 'Le prix Nobel de la paix', 'Aucune distinction internationale'], answer: 1 }
    ]
  },
  'cinema-et-critique': {
    ...
    parts: [
      ...
      "Au-delà de son succès critique, « Anatomie d’une chute » a également relancé un débat plus large sur la place des femmes derrière la caméra à Cannes, où seules deux autres réalisatrices avaient obtenu la Palme d’or avant Justine Triet. Ce film, aussi salué pour ses qualités formelles que pour la question qu’il pose implicitement sur la difficulté de connaître véritablement autrui, reste aujourd’hui l’un des exemples les plus cités du cinéma d’auteur français contemporain."
    ],
    exercises: [
      { type: 'mcq', prompt: 'Qui a réalisé « Anatomie d’une chute » ?', options: ['Justine Triet', 'Sandra Hüller', 'Arthur Harari seul', 'Un réalisateur allemand'], answer: 0 },
      { type: 'mcq', prompt: 'Quelle récompense ce film a-t-il obtenue à Cannes en 2023 ?', options: ['Le prix du jury', 'La Palme d’or', 'Le César du meilleur film', 'Aucune récompense'], answer: 1 },
      { type: 'mcq', prompt: 'Que raconte le film, selon le texte ?', options: ['Le procès d’une écrivaine soupçonnée d’avoir tué son mari', 'Une histoire d’amour à Paris', 'Un documentaire sur la montagne', 'Une comédie familiale'], answer: 0 },
      { type: 'mcq', prompt: 'Qu’est-ce qui a été unanimement salué par la critique ?', options: ['Les effets spéciaux', 'La performance de l’actrice Sandra Hüller', 'La musique du film', 'La durée très courte du film'], answer: 1 },
      { type: 'mcq', prompt: 'Quelle réserve certains critiques ont-ils exprimée sur le film ?', options: ['Un rythme jugé exigeant pendant les scènes de procès', 'Un manque d’acteurs professionnels', 'Une histoire incompréhensible', 'Une absence totale de dialogues'], answer: 0 },
  ...
  'dilemmes-ethiques': {
    ...
    exercises: [
      ...
      { type: 'mcq', prompt: 'Que propose de faire le dilemme du tramway ?', options: ['Choisir entre dévier un tramway vers une personne ou laisser mourir cinq personnes', 'Réparer un tramway en panne', 'Voter pour un nouveau système de transport', 'Créer une nouvelle ligne ferroviaire'], answer: 0 },
      { type: 'mcq', prompt: 'Que privilégie l’approche conséquentialiste dans ce dilemme ?', options: ['Le respect absolu de règles morales fixes', 'Le résultat de l’action, en sauvant le plus grand nombre', 'Le refus total d’agir', 'La consultation d’un tribunal'], answer: 1 },
      { type: 'mcq', prompt: 'Qu’est-ce que la plateforme « Moral Machine » du MIT ?', options: ['Un jeu vidéo commercial', 'Une plateforme ayant recueilli les préférences morales de millions de participants sur des scénarios liés aux voitures autonomes', 'Un tramway expérimental', 'Un cours de philosophie en ligne uniquement'], answer: 1 },
      { type: 'mcq', prompt: 'Où les résultats de cette étude ont-ils été publiés, et en quelle année ?', options: ['Dans la revue Nature, en 2018', 'Dans un journal local, en 1967', 'Ils n’ont jamais été publiés', 'Sur un blog personnel, en 2020'], answer: 0 },
      { type: 'mcq', prompt: 'Que révèlent ces travaux sur les préférences morales à travers le monde ?', options: ['Qu’elles sont identiques dans toutes les cultures', 'Qu’il existe des différences culturelles significatives', 'Qu’elles n’existent pas réellement', 'Qu’elles ne concernent que les philosophes'], answer: 1 }
    ]
  },
  'sciences-et-innovations': {
    ...
    exercises: [
      { type: 'mcq', prompt: 'À partir de quand l’intelligence artificielle générative comme ChatGPT s’est-elle massivement diffusée, selon le texte ?', options: ['Fin 2022', 'Dans les années 1990', 'En 2010', 'Le texte ne le précise pas'], answer: 0 },
      { type: 'mcq', prompt: 'Quelle organisation internationale a publié des rapports sur les effets de l’IA sur l’emploi ?', options: ['Le Fonds monétaire international', 'L’Organisation mondiale du commerce', 'L’Union européenne uniquement', 'Aucune organisation internationale'], answer: 0 },
      { type: 'mcq', prompt: 'Quelles sont les trois catégories d’effets distinguées par les économistes ?', options: ['Automatisation complète, transformation, création de nouveaux métiers', 'Augmentation, stagnation, diminution des salaires', 'Emplois publics, privés et associatifs', 'Emplois urbains, ruraux et internationaux'], answer: 0 },
  ...
  'histoire-et-memoire': {
    ...
    exercises: [
      ...
      { type: 'mcq', prompt: 'En quelle année la partie orientale de l’île (actuelle République dominicaine) a-t-elle accédé à une indépendance durable ?', options: ['1804', '1844', '1937', '1900'], answer: 1 },
      ...
      { type: 'mcq', prompt: 'Comment la mémoire officielle dominicaine a-t-elle longtemps traité ce massacre ?', options: ['Elle l’a largement célébré', 'Elle l’a longtemps minimisé', 'Elle l’a immédiatement documenté en détail', 'Elle n’en a jamais parlé, même aujourd’hui'], answer: 1 },
      { type: 'mcq', prompt: 'Sur quelle question actuelle cette mémoire historique continue-t-elle d’influencer les relations bilatérales ?', options: ['La question migratoire', 'Le tourisme uniquement', 'Le commerce du café', 'Les compétitions sportives'], answer: 0 },
      { type: 'mcq', prompt: 'Que tentent de faire plusieurs initiatives culturelles et académiques récentes, selon la conclusion ?', options: ['Effacer complètement cette histoire', 'Favoriser un dialogue historique plus ouvert entre les deux pays', 'Empêcher toute recherche sur le sujet', 'Réécrire l’histoire de façon unilatérale'], answer: 1 }
    ]
  },
  'ecologie-et-engagement-citoyen': {
    ...
    exercises: [
      ...
      { type: 'mcq', prompt: 'Quel rôle jouent les mangroves pour les communautés de pêcheurs locaux ?', options: ['Aucun rôle particulier', 'Elles servent de zone de reproduction pour de nombreuses espèces de poissons', 'Elles empêchent totalement la pêche', 'Elles ne concernent que le tourisme'], answer: 1 },
      ...
      { type: 'mcq', prompt: 'Que font de nombreuses associations locales face à ce constat ?', options: ['Elles abandonnent tout effort', 'Elles organisent des programmes de restauration impliquant les jeunes générations', 'Elles interdisent l’accès aux plages', 'Elles ne font rien de concret'], answer: 1 },
  ...
  'art-et-creativite': {
    ...
    exercises: [
      { type: 'mcq', prompt: 'En quelle année et où Wifredo Lam est-il né ?', options: ['En 1902, à Cuba', 'En 1943, en France', 'En 1980, en Espagne', 'En 1920, en Chine'], answer: 0 },
      { type: 'mcq', prompt: 'Quelles origines culturelles Wifredo Lam avait-il, selon le texte ?', options: ['Uniquement françaises', 'Chinoises, africaines, espagnoles et amérindiennes', 'Uniquement cubaines', 'Uniquement européennes'], answer: 1 },
      { type: 'mcq', prompt: 'Qui Wifredo Lam a-t-il fréquenté à Paris ?', options: ['Picasso et les surréalistes autour d’André Breton', 'Des politiciens uniquement', 'Aucun artiste connu', 'Des musiciens de jazz uniquement'], answer: 0 },
      ...
      { type: 'mcq', prompt: 'Comment la critique occidentale a-t-elle longtemps réagi face à l’œuvre de Lam ?', options: ['Elle l’a immédiatement célébrée sans réserve', 'Elle peinait à la classer dans une catégorie stable', 'Elle l’a totalement ignorée', 'Elle l’a considérée comme purement surréaliste, sans nuance'], answer: 1 },
  ...
  'bilan-et-projets-davenir': {
    ...
    parts: [
      ...
      "En fin de compte, ce que confirment la plupart des études longitudinales menées sur ce sujet, c’est que l’impact d’une mobilité internationale se prolonge bien au-delà de la durée du séjour lui-même. Loin de se limiter à un simple ajout sur un curriculum vitae, cette expérience continue, des années plus tard, à influencer la façon dont d’anciens étudiants abordent les décisions importantes de leur vie personnelle et professionnelle, avec une détermination et une ouverture qu’ils reconnaissent eux-mêmes ne pas avoir possédées avant leur départ."
    ],
    exercises: [
      { type: 'mcq', prompt: 'Quel est le nom du principal programme européen de mobilité étudiante mentionné dans le texte ?', options: ['Erasmus+', 'Frontex', 'Horizon Europe', 'Interrail'], answer: 0 },
      { type: 'mcq', prompt: 'Que révèle une enquête de grande ampleur sur les anciens étudiants Erasmus, selon le texte ?', options: ['Un taux d’insertion professionnelle nettement supérieur à celui des étudiants sans mobilité', 'Un taux de chômage plus élevé', 'Aucune différence mesurable', 'Un désintérêt pour le monde professionnel'], answer: 0 },
      ...
      { type: 'mcq', prompt: 'Quels effets moins visibles les chercheurs en psychologie du développement soulignent-ils ?', options: ['Une meilleure connaissance de soi et une plus grande tolérance à l’ambiguïté', 'Une perte totale de repères culturels', 'Une baisse de la confiance en soi', 'Un désintérêt pour les études'], answer: 0 },
