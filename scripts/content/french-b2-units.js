...
const REAL_B2_READINGS = {
  'retour-a-saint-domingue': {
    ...
    exercises: [
      ...
      { type: 'mcq', prompt: 'Que découvre parfois un étudiant après une immersion linguistique prolongée, selon le texte ?', options: ['Qu’il pense et réagit différemment, sans que son entourage le comprenne', 'Qu’il a totalement oublié sa langue maternelle', 'Qu’il préfère ne plus jamais voyager', 'Qu’il n’a rien appris pendant son séjour'], answer: 0 },
